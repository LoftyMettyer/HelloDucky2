...
Partial Class Home
   ...
   Protected Sub Page_Init(sender As Object, e As EventArgs) Handles Me.Init
      ...
      _sqlMetadata = db.GetSQLMetaData()
      ...
      For Each item In workflows
         ...
         link.NavigateUrl = WorkflowLink(item.Id, _sqlMetadata)
         link.Target = "_blank"
   ...
   Public Function WorkflowLink(ByVal workflowID As Integer, sqlMetaData As SQLMetaData) As String
      ...
      Dim sEncryptedString As String = objCrypt.EncryptQueryString((-1 * workflowID), -1, "XX", "XX", sqlMetaData.ServerName, sqlMetaData.DatabaseName, User.Identity.Name, "")
