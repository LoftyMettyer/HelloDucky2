...
Public Class [Default]
   ...
   Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.PreInit
      ...
      If message.IsNullOrEmpty() AndAlso Request.QueryString.Count > 1 Then
         Return
      End If

      'Page requested with no workflow details, just redirect to the login page
      If message.IsNullOrEmpty() AndAlso Request.QueryString.Count = 0 Then
         Session("CurrentStep") = Nothing
         Response.Redirect("~/Account/Login.aspx")
      End If

      If message.IsNullOrEmpty() Then _db = New Database(App.Config.ConnectionString)

      ' Validate the connection string
      If message.IsNullOrEmpty() AndAlso Not _db.CanConnect() Then
...
#End If
      ...
      If message.IsNullOrEmpty() AndAlso (Not IsPostBack And _url.InstanceId < 0 And _url.ElementId = -1) Then
