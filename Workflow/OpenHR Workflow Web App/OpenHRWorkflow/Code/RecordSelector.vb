...
Public Class RecordSelector
  ...
  Protected Overrides Sub Render(ByVal writer As System.Web.UI.HtmlTextWriter)
    ...
    ' Div to contain all items
      writer.Write("<div ID='" & Me.ID.ToString.Replace("Grid", "") & "' " & _
          ...
          General.GetHtmlColour(System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.FromArgb(customHeader.BackColor.A, customHeader.BackColor.R, customHeader.BackColor.G, customHeader.BackColor.B))) & _
          "'>")
    ...
    ' (This is the one with scrollbars) - too small for lookups
      writer.Write("<div id='" & ClientID.Replace("Grid", "") & "gridcontainer'  style='position:absolute;top:" & CalculateHeaderHeight() & _
                   ...
                   General.GetHtmlColour(System.Drawing.ColorTranslator.ToOle(System.Drawing.Color.FromArgb(Me.BackColor.A, Me.BackColor.R, Me.BackColor.G, Me.BackColor.B))) & _
  ...
  Private Sub RecordSelector_DataBound(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.DataBound
      ...
      Dim iEffectiveRowHeight As Integer = CInt(grdGrid.RowStyle.Height.Value)
