<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" Inherits="OpenHRWorkflow.ChangePassword" Codebehind="ChangePassword.aspx.vb" %>
    ...
    <ul class="footer-buttons col2">
        <li>
            ...
            <asp:HyperLink runat="server" ID="btnCancel" NavigateUrl="~/Home.aspx">
                <asp:Image runat="server"/>
                <asp:Label runat="server"/>
            </asp:HyperLink></li></ul></asp:Content>