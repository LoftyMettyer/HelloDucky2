...
Private Function CreateAbsenceDurationStoredProcedure(Optional pbCreateBreakdown As Boolean) As Boolean
  ...
  strProcHeader = "/* ------------------------------------------------ */" & vbNewLine & _
              "/* Absence module stored procedure.          */" & vbNewLine & _
  ...
  strUDFHeader = "/* ------------------------------------------------ */" & vbNewLine & _
              "/* Absence module user defined function.     */" & vbNewLine & _
              "/* Automatically generated by the System manager.   */" & vbNewLine & _
              "/* ------------------------------------------------ */" & vbNewLine & _
...
Private Function CreateAbsenceBetween2DatesStoredProcedure() As Boolean
  ...
  If fCreatedOK Then
    ...
    sAbsenceBetweenUDF = "/* ------------------------------------------------ */" & vbNewLine & _
               "/* Absence Between 2 Dates user defined function.     */" & vbNewLine & _
               "/* Automatically generated by the System manager.   */" & vbNewLine & _
               "/* ------------------------------------------------ */" & vbNewLine & _
    ...
    sBradfordUDF = "/* ------------------------------------------------ */" & vbNewLine & _
               "/* Absence Bradford Factor user defined function.     */" & vbNewLine & _
               "/* Automatically generated by the System manager.   */" & vbNewLine & _
               "/* ------------------------------------------------ */" & vbNewLine & _
    ...
    sBradfordUDF = sBradfordUDF & vbNewLine & _
        ...
        "    DECLARE @absences TABLE(duration float, instance integer);" & vbNewLine & _
        "    DECLARE @SplitID nvarchar(10)," & vbNewLine & _
        "            @Pos int;" & vbNewLine & vbNewLine
    ...
    If fValidConfiguration Then
      ...
      sBradfordUDF = sBradfordUDF & vbNewLine & _
          ...
          "    SELECT @iInstances = SUM(instance),@pdblBradford = SUM(duration) FROM @absences WHERE duration > 0;" & vbNewLine & vbNewLine
      End If
...
Private Function CreateSSPStoredProcedure() As Boolean
  ...
  'If fCreatedOK Then
    ...
    sProcSQL = "/* ------------------------------------------------ */" & vbNewLine & _
      ...
      "    @piPersonnelRecordID  integer" & vbNewLine & _
      ")" & vbNewLine & _
      "AS" & vbNewLine & _
      "BEGIN"
    ...
    sProcSQL = sProcSQL & vbNewLine & _
      ...
      "    DECLARE @iWorkingDaysPerWeek integer," & vbNewLine & _
    ...
    If fSSPRunningTableExists Then
      sProcSQL = sProcSQL & vbNewLine & _
        ...
        "        WHERE personnelRecordID = @piPersonnelRecordID" & vbNewLine & vbNewLine & _
        "        IF @fSSPRunning IS null INSERT INTO ASRSysSSPRunning (personnelRecordID, sspRunning) VALUES(@piPersonnelRecordID, 1)" & vbNewLine & _
        "        IF @fSSPRunning = 0 UPDATE ASRSysSSPRunning SET sspRunning = 1 WHERE personnelRecordID = @piPersonnelRecordID" & vbNewLine & _
    ...
    If Len(mvar_sPersonnel_DateOfBirthColumnName) > 0 Then
      sProcSQL = sProcSQL & vbNewLine & _
        ...
        "        WHERE id = @piPersonnelRecordID" & vbNewLine & vbNewLine & _
      ...
      Case 2  ' The Working Days is a numeric field reference.
        If (mvar_lngAbsenceWorkingDaysTableID = mvar_lngPersonnelTableID) Then
          sProcSQL = sProcSQL & vbNewLine & _
            ...
            "        FROM " & mvar_sPersonnelTableName & vbNewLine & _
            "        WHERE " & mvar_sPersonnelTableName & ".id = @piPersonnelRecordID" & vbNewLine
        Else
          sProcSQL = sProcSQL & _
      ...
      Case 3  ' The Working Days is a pattern field reference.
        If (mvar_lngAbsenceWorkingDaysTableID = mvar_lngPersonnelTableID) Then
          sProcSQL = sProcSQL & vbNewLine & _
            ...
            "        FROM " & mvar_sPersonnelTableName & vbNewLine & _
            "        WHERE " & mvar_sPersonnelTableName & ".id = @piPersonnelRecordID" & vbNewLine & _
    ...
    sProcSQL = sProcSQL & vbNewLine & _
      ...
      "            WHERE id_" & Trim(Str(mvar_lngPersonnelTableID)) & " = @piPersonnelRecordID;" & vbNewLine & vbNewLine & _
    ...
    sProcSQL = sProcSQL & vbNewLine & _
      ...
      "            WHERE " & mvar_sAbsenceTableName & ".id_" & Trim(Str(mvar_lngPersonnelTableID)) & " = @piPersonnelRecordID " & vbNewLine & _
    ...
    If fSSPRunningTableExists Then
      sProcSQL = sProcSQL & vbNewLine & _
        "    IF @fOK = 1" & vbNewLine & _
        "    BEGIN" & vbNewLine & _
        "        UPDATE ASRSysSSPRunning SET sspRunning = 0 WHERE personnelRecordID = @piPersonnelRecordID" & vbNewLine & _
        "    END" & vbNewLine & vbNewLine
    End If
