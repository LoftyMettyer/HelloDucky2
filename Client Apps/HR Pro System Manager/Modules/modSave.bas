...
Private Function ConfigureCategories() As Boolean
  ...
  ' Drop existing stuff
  bOK = DropProcedure("spssys_getobjectcategories")
  ...
  sSQL = "/* ---------------------------------------------------- */" & vbNewLine & _
            ...
            "/* Automatically generated by the System manager.    */" & vbNewLine & _
            "/* ---------------------------------------------------- */" & vbNewLine & _
            "CREATE PROCEDURE dbo.[spssys_getobjectcategories](@utilityType as integer, @UtilityID as integer, @tableID as integer)" & vbNewLine & _
            "AS" & vbNewLine & _
            "BEGIN" & vbNewLine & _
