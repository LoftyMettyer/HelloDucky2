...
'    .Redraw = False
    If frmDbMgr.ActiveView Is frmDbMgr.TreeView1 Then
      ...
      If frmDbMgr.TreeView1.SelectedItem.Tag = giNODE_RELATIONGROUP Then
    ...
    Else
      ...
      If frmDbMgr.ListView1.ListItems.Count > 0 And frmDbMgr.ListView1_SelectedCount > 0 Then
        ...
        Else
          ...
          '.Tools("ID_CopyTable").Enabled = (frmDbMgr.ListView1.SelectedItem.Tag And edtCopy)
          '.Tools("ID_CopyColumn").Enabled = (Not .Tools("ID_CopyTable").Enabled)
          .Tools("ID_CopyTable").Enabled = bCopyTable
...
' With the Toolbar Ctl on frmViewMgr
  With frmViewMgr
    ...
    .abViewMgr.Tools("ID_CopyView").Enabled = fEnableCopyView
  ...
  With tbMain
    ...
    .Tools("ID_CopyView").Enabled = fEnableCopyView
...
'    .ToolBars("Main Toolbar").Tools.Add "separator", , .ToolBars("Main Toolbar").Tools("ID_Properties").Index
    ...
    .Tools("ID_New").Visible = True
    .Tools("ID_Delete").Visible = True
    'NPG20080206 Fault 12874 Copy View Functionality Enabled Now
    .Tools("ID_CopyView").Visible = True
    .Tools("ID_Properties").Visible = True
    .Tools("ID_SelectAll").Visible = True
