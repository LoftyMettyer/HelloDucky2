...
Private Sub cmdOK_Click()
  ...
  '''      End If
        ...
        If Not (rsOtherColumns.BOF And rsOtherColumns.EOF) Then
          ...
          If MsgBox(sMsgBoxText, vbYesNo + vbQuestion, Application.Name) = vbYes Then
            ...
            For iNewIndex = 1 To UBound(sOtherCols, 2)
              ...
              Set objOtherCol = New HRProSystemMgr.Column
    ...
    With mobjColumn
      ...
      .Properties("dfltValueExprID") = mlngDfltValueExprID
      ...
      .Properties("lostFocusExprID") = mlngValidationExprID
...
Public Sub PrintDefinition()
  ...
  Dim objPrinter As HRProSystemMgr.clsPrintDef
  ...
  Set objPrinter = New HRProSystemMgr.clsPrintDef
  With objPrinter
    If .IsOK Then
