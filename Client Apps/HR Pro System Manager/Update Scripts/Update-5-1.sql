...
-- Insert the system permissions for Report Packs		
...
BEGIN
	INSERT dbo.[ASRSysPermissionCategories] ([CategoryID], [Description], [ListOrder], [CategoryKey], [Picture])
		VALUES (44, 'Report Packs', 10, 'REPORTPACKS',0x00);
...
--IF EXISTS(SELECT * FROM dbo.[ASRSysPermissionCategories] WHERE [categoryID] = 44)
--BEGIN
--	SELECT @ptrval = [picture]
