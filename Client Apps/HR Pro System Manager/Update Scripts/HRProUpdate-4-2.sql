...
END
/* This is the picture code for the Advanced little world icon which will probably be used in Sys Permissions when we go to new icons
Just uncomment and delete code above to use the new one.  NB - Script 4.0 has a load of icon updates and would be a good source base for codes and script in future.
