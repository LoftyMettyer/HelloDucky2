...
Begin VB.Form frmExprComponent 
   ...
   Begin VB.Frame fraComponent 
      ...
      Begin VB.CheckBox chkOnlyMyFilters 
         Caption         =   "On&ly show filters where owner is "
         Height          =   240
         Left            =   60
         TabIndex        =   103
         Top             =   600
   ...
   Begin VB.Frame fraComponent 
      ...
      Begin VB.CheckBox chkOnlyMine 
         Caption         =   "On&ly show calculations where owner is "
         Height          =   240
         Left            =   120
         TabIndex        =   34
         Top             =   585
   ...
   Begin VB.Frame fraComponent 
      ...
      Begin VB.ComboBox cboTabValTable 
         Height          =   315
         ItemData        =   "frmComponent.frx":0156
         Left            =   930
         List            =   "frmComponent.frx":0158
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   39
         Top             =   250
      ...
      Begin VB.ComboBox cboTabValColumn 
         Height          =   315
         ItemData        =   "frmComponent.frx":015A
         Left            =   930
         List            =   "frmComponent.frx":015C
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   40
         Top             =   650
      ...
      Begin VB.ComboBox cboTabValValue 
         Height          =   315
         ItemData        =   "frmComponent.frx":015E
         Left            =   930
         List            =   "frmComponent.frx":0160
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   41
         Top             =   1050
   ...
   Begin VB.Frame fraComponent 
      ...
      Begin VB.ComboBox cboCustCalculation 
         Height          =   315
         ItemData        =   "frmComponent.frx":0162
         Left            =   1100
         List            =   "frmComponent.frx":0172
         Style           =   2  'Dropdown List
         TabIndex        =   35
         Top             =   250
         Width           =   1000
      ...
      Begin VB.Frame fraCustParameters 
         ...
         Begin VB.ComboBox cboCustTable 
            Height          =   315
            ItemData        =   "frmComponent.frx":0199
            Left            =   650
            List            =   "frmComponent.frx":01A9
            Style           =   2  'Dropdown List
            TabIndex        =   37
            Top             =   1200
            Width           =   1000
         ...
         Begin VB.ComboBox cboCustField 
            Height          =   315
            ItemData        =   "frmComponent.frx":01D0
            Left            =   650
            List            =   "frmComponent.frx":01E0
            Style           =   2  'Dropdown List
            TabIndex        =   38
            Top             =   1600
            Width           =   1000
   ...
   Begin VB.Frame fraComponent 
      ...
      Begin VB.Frame fraPValValueType 
         ...
         Begin VB.ComboBox cboPValReturnType 
            Height          =   315
            ItemData        =   "frmComponent.frx":0207
            Left            =   120
            List            =   "frmComponent.frx":021A
            Style           =   2  'Dropdown List
            TabIndex        =   49
            Top             =   255
            Width           =   1000
      ...
      Begin VB.Frame fraPValDefaultValue 
         ...
         Begin TDBNumber6Ctl.TDBNumber TDBPValDefaultNumeric 
            ...
            _ExtentX        =   1773
            _ExtentY        =   556
            Calculator      =   "frmComponent.frx":024D
            Caption         =   "frmComponent.frx":026D
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               Name            =   "Verdana"
               Size            =   8.25
               Charset         =   0
               ...
               Strikethrough   =   0   'False
            EndProperty
            DropDown        =   "frmComponent.frx":02D2
            Keys            =   "frmComponent.frx":02F0
            Spin            =   "frmComponent.frx":033A
            AlignHorizontal =   1
            AlignVertical   =   0
            Appearance      =   1
            BackColor       =   -2147483643
   ...
   Begin VB.Frame fraComponent 
      ...
      Begin VB.ComboBox cboFldTable 
         Height          =   315
         ItemData        =   "frmComponent.frx":0409
         Left            =   1000
         List            =   "frmComponent.frx":040B
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   15
         Top             =   615
...
Public Property Set Component(pobjComponent As clsExprComponent)
  ...
  'Added so that the default frame for a Record Independent Calculation is the Function not Field.
  'Field frame will be shown when adding a BYREF Field type component to the Expression.
  If (miComponentType = giCOMPONENT_FIELD) _
    And (mfFieldByValue) _
    And (mobjComponent.ParentExpression.ExpressionType = giEXPR_RECORDINDEPENDANTCALC) Then
    miComponentType = giCOMPONENT_FUNCTION
  End If
...
Private Sub cboPValTable_Refresh()
  ...
  Set rsTable = datGeneral.GetRecords(sSQL)
  With rsTable
...
Private Sub InitializeTableValueControls()
  ...
  iOriginalReturnType = mobjComponent.Component.ReturnType
  ...
  If cboTabValTable.Enabled Then
    ...
    With mobjComponent.Component
        Select Case .ReturnType
            ...
            Case giEXPRVALUE_DATE
              'JPD 20031211 Fault 7807
              If iOriginalReturnType = giEXPRVALUE_DATE Then
                'JPD 20041118 Fault 8231
...
Private Sub cboValType_Refresh()
  ...
  'JPD 20031212 Fault 7794
  If cboValType.ListIndex = iIndex Then
    cboValType_Click
  Else
...
Private Sub listCalcCalculation_Initialize()
  ...
  If (mobjComponent.ParentExpression.ExpressionType = giEXPR_RUNTIMECALCULATION) Or _
    ...
    sSQL = "SELECT name, exprID" & _
      ...
      " AND ((Username = '" & datGeneral.UserNameForSQL & "'" & _
  ...
  If Me.chkOnlyMine.Value Then sSQL = sSQL & " AND Username = '" & datGeneral.UserNameForSQL & "'"
  
  Set rsCalculations = datGeneral.GetRecords(sSQL)
  With rsCalculations
    Do While Not .EOF
...
Private Sub listCalcFilter_Initialize()
  ...
  If (mobjComponent.ParentExpression.ExpressionType = giEXPR_RUNTIMECALCULATION) Or _
    ...
    sSQL = "SELECT name, exprID" & _
      ...
      If Me.chkOnlyMyFilters.Value Then sSQL = sSQL & " AND Username = '" & datGeneral.UserNameForSQL & "'"

  End If
  
  Set rsFilters = datGeneral.GetRecords(sSQL)
  With rsFilters
    Do While Not .EOF
...
Private Sub ssTreeFuncFunction_Initialize()
  ...
  For Each objFunctionDef In gobjFunctionDefs
    fValid = ((mobjComponent.ParentExpression.ExpressionType <> giEXPR_VIEWFILTER) And _
      ...
      (objFunctionDef.Runtime) Or (objFunctionDef.UDF And (mobjComponent.ParentExpression.ExpressionType <> giEXPR_RECORDINDEPENDANTCALC))
    ...
    If fValid Then
      Select Case objFunctionDef.ID
        ...
        Case 66, 70 'Is Post That Reports To Current User, Is Post That Current User Reports To
          fValid = (mobjComponent.ParentExpression.ExpressionType <> giEXPR_RECORDINDEPENDANTCALC) _
            And (mobjComponent.ParentExpression.BaseTableID = glngHierarchyTableID) _
            And modPersonnelSpecifics.HierarchyFunctionConfigured(objFunctionDef.ID)
        ...
        Case 30, 47, 46 'Absence root and calcs:Absence Duration, Absence Between Two Date, Days between Two Dates
          fValid = (mobjComponent.ParentExpression.ExpressionType <> giEXPR_RECORDINDEPENDANTCALC) _
            And ((mobjComponent.ParentExpression.BaseTableID = glngPersonnelTableID) _
              Or datGeneral.IsAChildOf(mobjComponent.ParentExpression.BaseTableID, glngPersonnelTableID))
        
        Case 73 'Bradford
          fValid = (mobjComponent.ParentExpression.ExpressionType <> giEXPR_RECORDINDEPENDANTCALC) _
            And gfAbsenceEnabled _
            And ((mobjComponent.ParentExpression.BaseTableID = glngPersonnelTableID) _
              Or datGeneral.IsAChildOf(mobjComponent.ParentExpression.BaseTableID, glngPersonnelTableID))
...
Private Sub cboFldTable_Refresh()
  ...
  lngSecondTableID = mobjComponent.ParentExpression.SecondTableID
  iIndex = -1
  iDefaultIndex = -1
    ...
    If mfFieldByValue Then
      If optField(0).Value Then
        sSQL = "SELECT ASRSysTables.tableName, ASRSysTables.tableID" & _
          " FROM ASRSysTables" & _
          " WHERE ASRSysTables.tableId = " & CStr(lngRootTableID) & _
          " OR ASRSysTables.tableId = " & CStr(lngSecondTableID)
  
        ' Only add parent and child tables to the combo if the current expression is not
        ' a View Filter.
'MH20030909 Only allow match expressions from the two tables specified
        If mobjComponent.ParentExpression.ExpressionType <> giEXPR_VIEWFILTER And _
           mobjComponent.ParentExpression.ExpressionType <> giEXPR_MATCHJOINEXPRESSION And _
           mobjComponent.ParentExpression.ExpressionType <> giEXPR_MATCHWHEREEXPRESSION And _
           mobjComponent.ParentExpression.ExpressionType <> giEXPR_MATCHSCOREEXPRESSION Then
          sSQL = sSQL & _
            " UNION" & _
...
Private Sub fldSelOrder_Refresh()
  ...
  sSQL = "SELECT name" & _
    ...
    " AND tableID = " & Trim(Str(mobjComponent.Component.TableID))
  Set rsOrder = datGeneral.GetRecords(sSQL)
  With rsOrder
    fOK = Not (.EOF And .BOF)
...
'      fCalculationEnabled = False
    ...
    Case giEXPR_UTILRUNTIMEFILTER, giEXPR_MATCHJOINEXPRESSION, giEXPR_MATCHWHEREEXPRESSION, giEXPR_MATCHSCOREEXPRESSION
      fCalculationEnabled = False
      fPromptedValueEnabled = False
    ...
    Case giEXPR_RECORDINDEPENDANTCALC
      ...
      fCalculationEnabled = False
      'TM20030604 Fault 5759 - allow prompted record independent calcs.
      'fPromptedValueEnabled = False
      fFilterEnabled = False
...
'  'NHRD11102004 Fault 3792
'  Select Case asrPValReturnDecimals.Text
'    Case 0
'        TDBPValDefaultNumeric.DisplayFormat = "##,###,##0.#######; -##,###,##0.#######"
'        TDBPValDefaultNumeric.Text = Format(TDBPValDefaultNumeric.Text, "##,###,##0.#######; -##,###,##0.#######")
'        'cmdOK.Enabled = True
'    Case 1
'        TDBPValDefaultNumeric.DisplayFormat = "##,###,##0.0######; -##,###,##0.0######"
'        TDBPValDefaultNumeric.Text = Format(TDBPValDefaultNumeric.Text, "##,###,##0.0######; -##,###,##0.0######")
'        'cmdOK.Enabled = True
'    Case 2
'        TDBPValDefaultNumeric.DisplayFormat = "##,###,##0.00#####; -##,###,##0.00#####"
'        TDBPValDefaultNumeric.Text = Format(TDBPValDefaultNumeric.Text, "##,###,##0.00#####; -##,###,##0.00#####")
'        'cmdOK.Enabled = True
'    Case 3
'        TDBPValDefaultNumeric.DisplayFormat = "##,###,##0.000####; -##,###,##0.000####"
'        TDBPValDefaultNumeric.Text = Format(TDBPValDefaultNumeric.Text, "##,###,##0.000####; -##,###,##0.000####")
'        'cmdOK.Enabled = True
'    Case 4
'        TDBPValDefaultNumeric.DisplayFormat = "##,###,##0.0000###; -##,###,##0.0000###"
'        TDBPValDefaultNumeric.Text = Format(TDBPValDefaultNumeric.Text, "##,###,##0.0000###; -##,###,##0.0000###")
'        'cmdOK.Enabled = True
'  End Select
...
Private Sub FormatFieldControls()
  ...
  If mobjComponent.ParentExpression.ExpressionType = giEXPR_MATCHSCOREEXPRESSION Then
    optField(0).Value = True
  ...
  cboFldColumn.BackColor = IIf(cboFldColumn.Enabled, vbWindowBackground, vbButtonFace)
  'NHRD07102004 Fault 6975
  cboFldTable.BackColor = IIf(cboFldTable.Enabled, vbWindowBackground, vbButtonFace)
  ...
  If (mfFieldByValue) Then
    ...
    Set rsRelation = datGeneral.GetRecords(sSQL)
    With rsRelation
...
'        (mobjComponent.ParentExpression.ExpressionType <> giEXPR_MATCHSCOREEXPRESSION))
    ...
    asrFldSelLine.BackColor = IIf(asrFldSelLine.Enabled, vbWindowBackground, vbButtonFace)
...
Private Sub FormatPromptedValueControls()
  ...
  txtPValFormat.BackColor = IIf(fFormatEnabled, vbWindowBackground, &H8000000F)
...
Private Sub cmdOK_Click()
  'NHRD17082004 Fault 8895
'  If cboValType.Text = "Date" Then
...
'    If ValidateGTMaskDate(asrPValDefaultDate) = False Or _
'       ValidateGTMaskDate(asrValDateValue) = False Then
'          Exit Sub
'    End If
'  End If
  
  If asrPValDefaultDate.Visible Then
    If ValidateGTMaskDate(asrPValDefaultDate) = False Then
      Exit Sub
    End If
    
'    With asrPValDefaultDate      'NHRD09092004 Fault 8895
...
'    End With
  ...
  If asrValDateValue.Visible Then
    If ValidateGTMaskDate(asrValDateValue) = False Then
      Exit Sub
    End If
    
    With asrValDateValue      'NHRD09092004 Fault 8895
      If Len(Trim(Replace(.Text, UI.GetSystemDateSeparator, ""))) = 0 Then
        Clipboard.Clear
        Clipboard.SetText .Text
        .DateValue = Null
...
Private Sub Form_Initialize()
  ...
  mbEnableViewFilter = datGeneral.SystemPermission("FILTERS", "VIEW")
  mbEnableEditFilter = datGeneral.SystemPermission("FILTERS", "EDIT")
  mbEnableViewCalculation = datGeneral.SystemPermission("CALCULATIONS", "VIEW")
  mbEnableEditCalculation = datGeneral.SystemPermission("CALCULATIONS", "EDIT")
...
Private Sub FormatScreen()
  ...
  Const iCOMPONENTFRAMEWIDTH = 2300
...
Private Sub FormatPromptedValueFrame()
  ...
  With TDBPValDefaultNumeric
    ...
    datGeneral.FormatTDBNumberControl TDBPValDefaultNumeric
  End With
...
Private Sub FormatValueFrame()
  ...
  With TDBValNumericValue
    ...
    'MH20010130 Fault 1610
    datGeneral.FormatTDBNumberControl TDBValNumericValue
  End With
...
Private Sub FormatFieldFrame()
  ...
  ' Format the Field - Table controls.
  With cboFldTable
    .Left = lngCOLUMN2
    .Top = lngYCoordinate
    .Width = lngCONTROLWIDTH
  ...
  ' Format the Field - Column controls.
  With cboFldColumn
    .Left = lngCOLUMN2
    .Top = lngYCoordinate
    .Width = lngCONTROLWIDTH
...
Private Sub listCalcCalculation_Click()
  ...
  If (Not gfCurrentUserIsSysSecMgr) And _
    (datGeneral.CalcIsReadOnly(mobjComponent.Component.CalculationID)) Then
...
Private Sub listCalcFilters_Click()
  ...
  If (Not gfCurrentUserIsSysSecMgr) And _
    (datGeneral.CalcIsReadOnly(mobjComponent.Component.FilterID)) Then
    Me.cmdEditFilter.Caption = "Vie&w Filter..."
...
'NHRD22092004 Fault 8918
If asrPValDefaultDate.Enabled = False Then
  asrPValDefaultDate.BackColor = vbButtonFace
  asrPValDefaultDate.Text = ""
Else
  asrPValDefaultDate.BackColor = vbWindowBackground
End If
...
Private Sub TDBPValDefaultNumeric_GotFocus()
  UI.txtSelNumeric
End Sub
...
Private Sub TDBPValDefaultNumeric_KeyUp(KeyCode As Integer, Shift As Integer)
'NHRD20092005 Fault 5331
  Dim intDec As Integer

  asrPValReturnSize.Value = Len(TDBPValDefaultNumeric.Text)

  If InStr(TDBPValDefaultNumeric.Text, ".") > 0 Then
    intDec = Len(Mid(TDBPValDefaultNumeric.Text, (InStr(TDBPValDefaultNumeric.Text, ".")))) - 1
    If intDec <= 4 Then
...
Private Sub txtPValDefaultCharacter_KeyUp(KeyCode As Integer, Shift As Integer)
  asrPValReturnSize.Value = Len(txtPValDefaultCharacter.Text)
End Sub
