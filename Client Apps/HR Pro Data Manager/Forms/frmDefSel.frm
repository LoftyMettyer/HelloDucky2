...
Select Case KeyCode
  Case vbKeyF1
    If 1 = 1 Then 'airehelp exists
      AIRhelp = App.Path & "\HR Pro Data Manager Help\HR Pro Data Manager Helpjkj.exe"
      ...
      If plngHelp <> 42 Then
        Select Case plngHelp
          ...
          Case Else
            ShellErrMessage = "Undocumented ShelleExecute Error occurred."
        End Select
      
        If ASRDEVELOPMENT Then
          'More technical response for programmer
          COAMsgBox ShellErrMessage & vbCrLf & vbCrLf & "Please use windows explorer to view the file 'HR Pro Data Manager Help.exe'.", vbExclamation + vbOKOnly, "HR Pro Data Manager AIR Help"
        Else
          'Less technical response for user
          COAMsgBox "Error whilst attempting to display AIR help file." & vbCrLf & vbCrLf & "Please use windows explorer to view the file 'HR Pro Data Manager Help.exe'.", vbExclamation + vbOKOnly, "HR Pro Data Manager AIR Help"
        End If
      End If
    Else
      'If no AIR then put in kicking off CHM code here.
