...
namespace Fusion.Test.SocialCare.Messages
{
    ...
    /// </summary>
    public class ServiceUserHomeAddressChangeRequestRequestXmlMetadataExtract : FusionXmlMetadataExtract<ServiceUserHomeAddressChangeRequest>
    {
        /// <summary>
        ...
        /// </returns>
        public override FusionXmlMetadata GetMetadataFromXml(ServiceUserHomeAddressChangeRequest message)
        {
            ...
            var rootNode = fusionDocument.Element(ns + "serviceUserHomeAddressChange");
