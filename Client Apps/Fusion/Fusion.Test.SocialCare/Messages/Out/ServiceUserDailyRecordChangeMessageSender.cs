...
namespace Fusion.Test.SocialCare.MessageSenders
{
    ...
    /// </summary>
    public class ServiceUserHomeDailyRecordChangeMessageSender : MessageSender<ServiceUserDailyRecordChangeMessage>
    {
        /// <summary>
        ...
        public override void Send(ServiceUserDailyRecordChangeMessage message)
        {
