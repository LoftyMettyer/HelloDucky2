...
namespace Fusion.Test.SocialCare.Messages
{
    ...
    /// </summary>
    public class StaffPostChangeRequestXmlMetadataExtract : FusionXmlMetadataExtract<StaffPostChangeRequest>
    {
        /// <summary>
        ...
        /// </returns>
        public override FusionXmlMetadata GetMetadataFromXml(StaffPostChangeRequest message)
        {
            ...
            var rootNode = fusionDocument.Element(ns + "staffPostChange");

            string entityRef = (string)rootNode.Attribute("staffPostRef");
