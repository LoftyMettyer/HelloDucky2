...
namespace Fusion.Test.SocialCare.MessageSenders
{
    ...
    /// </summary>
    public class ServiceUserCareDeliveryAddressChangeRequestMessageSender : MessageSender<ServiceUserCareDeliveryAddressChangeRequest>
    {
        /// <summary>
        ...
        public override void Send(ServiceUserCareDeliveryAddressChangeRequest message)
        {
