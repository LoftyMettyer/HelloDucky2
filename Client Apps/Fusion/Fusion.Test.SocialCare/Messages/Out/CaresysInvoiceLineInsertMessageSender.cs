...
namespace Fusion.Test.SocialCare.MessageSenders
{
    ...
    /// </summary>
    public class CaresysInvoiceLineInsertMessageSender : MessageSender<CaresysInvoiceLineInsertMessage>
    {
        /// <summary>
        ...
        public override void Send(CaresysInvoiceLineInsertMessage message)
        {
