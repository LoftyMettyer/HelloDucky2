...
namespace Fusion.Test.SocialCare.Messages
{
    ...
    /// </summary>
    public class FundingChangeMessageXmlMetadataExtract : FusionXmlMetadataExtract<FundingChangeMessage>
    {
        /// <summary>
        ...
        /// </returns>
        public override FusionXmlMetadata GetMetadataFromXml(FundingChangeMessage message)
        {
            ...
            var rootNode = fusionDocument.Element(ns + "fundingChange");
