...
namespace Fusion.Test.SocialCare.MessageSenders
{
    ...
    /// </summary>
    public class ServiceUserHomeAddressChangeRequestMessageSender : MessageSender<ServiceUserHomeAddressChangeRequest>
    {
        /// <summary>
        ...
        public override void Send(ServiceUserHomeAddressChangeRequest message)
        {
