...
namespace Fusion.Test.SocialCare.Messages
{
    ...
    /// </summary>
    public class vXmlMetadataExtract : FusionXmlMetadataExtract<ServiceUserDailyRecordChangeMessage>
    {
        /// <summary>
        ...
        /// </returns>
        public override FusionXmlMetadata GetMetadataFromXml(ServiceUserDailyRecordChangeMessage message)
        {
            ...
            var rootNode = fusionDocument.Element(ns + "serviceUserDailyRecordChange");

            string entityRef = (string)rootNode.Attribute("serviceUserDailyRecordRef");
