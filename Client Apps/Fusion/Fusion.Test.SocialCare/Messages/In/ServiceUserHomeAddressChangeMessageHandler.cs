...
namespace Fusion.Test.SocialCare.MessageHandlers
{
    ...
    /// </summary>
    public class ServiceUserHomeAddressChangeMessageHandler : BaseWriteFileMessageHandler, IHandleMessages<ServiceUserHomeAddressChangeMessage>
    {
        public void Handle(ServiceUserHomeAddressChangeMessage message)
        {
