...
namespace Fusion.Test.SocialCare.MessageHandlers
{
    ...
    /// </summary>
    public class StaffPostChangeMessageHandler : BaseWriteFileMessageHandler, IHandleMessages<StaffPostChangeMessage>
    {
        public void Handle(StaffPostChangeMessage message)
        {
