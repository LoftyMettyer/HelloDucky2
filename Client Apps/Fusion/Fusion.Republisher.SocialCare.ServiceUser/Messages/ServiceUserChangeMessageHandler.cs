...
namespace Fusion.Republisher.SocialCare
{
    ...
    public class ServiceUserChangeRequestMessageHandler : IHandleMessages<ServiceUserChangeRequest> {
        ...
        public void Handle(ServiceUserChangeRequest message)
        {
            Logger.Info(string.Format("Fusion Publisher received ServiceUserChangeRequest with Id {0}.", message.Id));
            ...
            // Blind republish
            Bus.Publish(new ServiceUserChangeMessage
            {
