...
//                    if (message != null)
//                    {
//                        PublishMessageRequest publishMessage = new PublishMessageRequest
//                        {
//                            EntityRef = new Guid(message.LocalId),
//                            Originator = "PUBLISHER",
//                            TriggerDateUtc = message.TriggerDate
//                        };


//                        // Need a publisher builder here instead
