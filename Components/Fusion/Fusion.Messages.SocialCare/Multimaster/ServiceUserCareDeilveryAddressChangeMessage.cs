...
namespace Fusion.Messages.SocialCare
{
    ...
    public class ServiceUserCareDeliveryAddressChangeMessage : FusionMessage, IEvent
    {
    }

    public class ServiceUserCareDeliveryAddressChangeRequest : FusionMessage, ICommand
    {
    }
