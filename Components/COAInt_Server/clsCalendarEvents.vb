...
Friend Class clsCalendarEvents
	...
	Public Function Add(ByRef pstrKey As String, ByRef pstrName As String, Optional ByRef plngTableID As Integer = 0, Optional ByRef pstrTableName As String = "", Optional ByRef plngFilterID As Integer = 0, Optional ByRef plngStartDateID As Integer = 0, Optional ByRef pstrStartDateName As String = "", Optional ByRef plngStartSessionID As Integer = 0, Optional ByRef pstrStartSessionName As String = "", Optional ByRef plngEndDateID As Integer = 0, Optional ByRef pstrEndDateName As String = "", Optional ByRef plngEndSessionID As Integer = 0, Optional ByRef pstrEndSessionName As String = "", Optional ByRef plngDurationID As Integer = 0, Optional ByRef pstrDurationName As String = "", Optional ByRef pintLegendType As Short = 0, Optional ByRef pstrLegendCharacter As String = "", Optional ByRef plngLegendTableID As Integer = 0, Optional ByRef pstrLegendTableName As String = "", Optional ByRef plngLegendColumnID As Integer = 0, Optional ByRef pstrLegendColumnName As String = "", Optional ByRef plngLegendCodeID As Integer = 0, Optional ByRef pstrLegendCodeName As String = "", Optional ByRef plngLegendEventTypeID As Integer = 0, Optional ByRef pstrLegendEventTypeName As String = "", Optional ByRef plngDesc1ID As Integer = 0, Optional ByRef pstrDesc1Name As String = "", Optional ByRef plngDesc2ID As Integer = 0, Optional ByRef pstrDesc2Name As String = "", Optional ByRef pstrBaseDescription As String = "", Optional ByRef pstrRegion As String = "", Optional ByRef pstrWorkingPattern As String = "", Optional ByRef pstrDesc1Value As String = "", Optional ByRef pstrDesc2Value As String = "") As clsCalendarEvent
