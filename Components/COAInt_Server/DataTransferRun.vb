...
Public Class clsDataTransferRun
	...
	Public Function SetPromptedValues(ByRef pavPromptedValues(,) As string) As Boolean
		...
		Catch ex As Exception
			Logs.AddDetailEntry("Error setting prompted values." & vbNewLine & ex.Message.RemoveSensitive())
    ...
    Private Function GetPicklistFilterSelect() As String
        ...
        ElseIf mlngFilterID > 0 Then
            ...
            fOK = FilteredIDs(mlngFilterID, GetPicklistFilterSelect, mastrUDFsRequired, mvarPrompts)
