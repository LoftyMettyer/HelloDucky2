...
Begin VB.Form frmMessageBox 
   ...
   Begin VB.Image imgIcon 
      ...
      Index           =   1
      Left            =   120
      Picture         =   "frmMessageBox.frx":044E
      Top             =   240
      Width           =   480
   End
   Begin VB.Image imgIcon 
      ...
      Index           =   2
      Left            =   120
      Picture         =   "frmMessageBox.frx":0890
      Top             =   240
      Width           =   480
   End
   Begin VB.Image imgIcon 
      ...
      Index           =   3
      Left            =   120
      Picture         =   "frmMessageBox.frx":0CD2
      Top             =   240
      Width           =   480
   End
End
...
Private Const lngCharPerLine = 30
...
'********************************************************************************
  ...
  With Me
    If CheckBox Then
      .Height = lngYPos + (3 * lngYCONTROLOFFSET)
    Else
...
Public Function MessageBox(sPrompt As String, Buttons As Integer, _
  ...
  If Not IsMissing(iCheckBoxValue) Then iCheckBoxValue = CheckBoxValue
  MessageBox = Answer
...
Public Function ErrorBox(pstrDetails As String) As Integer
  ...
  Message = "An unexpected program error has occured."
