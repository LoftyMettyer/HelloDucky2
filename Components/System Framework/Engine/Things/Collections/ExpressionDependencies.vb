...
Namespace Collections
  ...
  Public Class ExpressionDependencies
    ...
    Private ReadOnly _colCode As New Collection(Of GeneratedUdf)
    ...
    Public Overloads Function Add(ByVal pobjExpression As Expression) As String
      ...
      For Each objThing As GeneratedUdf In _colCode
    ...
    Public Overloads Function Add(ByVal child As ChildRowDetails) As Integer
      ...
      If Not bFound Then
        ...
        If child.RowSelection = ColumnRowSelection.Total Or child.RowSelection = ColumnRowSelection.Count Then
    ...
    Public ReadOnly Property Statements As ICollection(Of GeneratedUdf)
      Get
        Return _colCode
      End Get
    End Property
