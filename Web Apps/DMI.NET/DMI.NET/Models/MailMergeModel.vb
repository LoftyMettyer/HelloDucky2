...
Namespace Models
    ...
    Public Class MailMergeModel
        ...
        <MinLength(3, ErrorMessage:="You must select at least one column for your mail merge.")>
        ...
        Public Property UploadTemplate As Byte()
            Get
                Return _uploadTemplate
            End Get
            Set(value As Byte())
                _uploadTemplate = value
            End Set
        End Property
        ...
        <MaxLength(255, ErrorMessage:="Email attachment cannot be longer than 255 characters.")>
