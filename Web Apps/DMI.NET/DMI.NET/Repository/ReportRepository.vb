   ...
   Public Class ReportRepository
      ...
      Public Function LoadCrossTab(ID As Integer, action As UtilityActionType) As CrossTabModel
         ...
         Try
            ...
            Else
               ...
               Dim dtDefinition = _objDataAccess.GetFromSP("spASRIntGetCrossTabDefinition",
                     New SqlParameter("piReportID", SqlDbType.Int) With {.Value = objModel.ID},
                     New SqlParameter("psCurrentUser", SqlDbType.VarChar, 255) With {.Value = _username},
                     New SqlParameter("psAction", SqlDbType.VarChar, 255) With {.Value = action})
      ...
      Public Function LoadNineBoxGrid(ID As Integer, action As UtilityActionType) As NineBoxGridModel
         ...
         Try
            ...
            Else
               ...
               Dim dtDefinition = _objDataAccess.GetFromSP("spASRIntGetNineBoxGridDefinition",
                     New SqlParameter("piReportID", SqlDbType.Int) With {.Value = objModel.ID},
                     New SqlParameter("psCurrentUser", SqlDbType.VarChar, 255) With {.Value = _username},
                     New SqlParameter("psAction", SqlDbType.VarChar, 255) With {.Value = action})
      ...
      Public Function LoadCalendarReport(ID As Integer, action As UtilityActionType) As CalendarReportModel
         ...
         Try
            ...
            Else
               ...
               Dim dsDefinition = _objDataAccess.GetDataSet("spASRIntGetCalendarReportDefinition",
                     New SqlParameter("@piCalendarReportID", SqlDbType.Int) With {.Value = objModel.ID},
                     New SqlParameter("psCurrentUser", SqlDbType.VarChar, 255) With {.Value = _username},
                     New SqlParameter("psAction", SqlDbType.VarChar, 255) With {.Value = action})
      ...
      Public Function SaveReportDefinition(objModel As CrossTabModel) As Boolean
         ...
         Try
            ...
            _objDataAccess.ExecuteSP("spASRIntSaveCrossTab",
                        New SqlParameter("psName", SqlDbType.VarChar, 255) With {.Value = objModel.Name},
                        New SqlParameter("psDescription", SqlDbType.VarChar, -1) With {.Value = objModel.Description},
                        New SqlParameter("piTableID", SqlDbType.Int) With {.Value = objModel.BaseTableID},
                        New SqlParameter("piSelection", SqlDbType.Int) With {.Value = objModel.SelectionType},
                        New SqlParameter("piPicklistID", SqlDbType.Int) With {.Value = objModel.PicklistID},
                        New SqlParameter("piFilterID", SqlDbType.Int) With {.Value = objModel.FilterID},
                        New SqlParameter("pfPrintFilter", SqlDbType.Bit) With {.Value = objModel.DisplayTitleInReportHeader},
                        New SqlParameter("psUserName", SqlDbType.VarChar, 255) With {.Value = objModel.Owner},
                        New SqlParameter("piHColID", SqlDbType.Int) With {.Value = objModel.HorizontalID},
                        New SqlParameter("psHStart", SqlDbType.VarChar, 100) With {.Value = objModel.HorizontalStart},
                        New SqlParameter("psHStop", SqlDbType.VarChar, 100) With {.Value = objModel.HorizontalStop},
                        New SqlParameter("psHStep", SqlDbType.VarChar, 100) With {.Value = objModel.HorizontalIncrement},
                        New SqlParameter("piVColID", SqlDbType.Int) With {.Value = objModel.VerticalID},
                        New SqlParameter("psVStart", SqlDbType.VarChar, 100) With {.Value = objModel.VerticalStart},
                        New SqlParameter("psVStop", SqlDbType.VarChar, 100) With {.Value = objModel.VerticalStop},
                        New SqlParameter("psVStep", SqlDbType.VarChar, 100) With {.Value = objModel.VerticalIncrement},
                        New SqlParameter("piPColID", SqlDbType.Int) With {.Value = objModel.PageBreakID},
                        New SqlParameter("psPStart", SqlDbType.VarChar, 100) With {.Value = objModel.PageBreakStart},
                        New SqlParameter("psPStop", SqlDbType.VarChar, 100) With {.Value = objModel.PageBreakStop},
                        New SqlParameter("psPStep", SqlDbType.VarChar, 100) With {.Value = objModel.PageBreakIncrement},
                        New SqlParameter("piIType", SqlDbType.Int) With {.Value = objModel.IntersectionType},
                        New SqlParameter("piIColID", SqlDbType.Int) With {.Value = objModel.IntersectionID},
                        New SqlParameter("pfPercentage", SqlDbType.Bit) With {.Value = objModel.PercentageOfType},
                        New SqlParameter("pfPerPage", SqlDbType.Bit) With {.Value = objModel.PercentageOfPage},
                        New SqlParameter("pfSuppress", SqlDbType.Bit) With {.Value = objModel.SuppressZeros},
                        New SqlParameter("pfUse1000Separator", SqlDbType.Bit) With {.Value = objModel.UseThousandSeparators},
                        New SqlParameter("pfOutputPreview", SqlDbType.Bit) With {.Value = objModel.Output.IsPreview},
                        New SqlParameter("piOutputFormat", SqlDbType.Int) With {.Value = objModel.Output.Format},
                        New SqlParameter("pfOutputScreen", SqlDbType.Bit) With {.Value = objModel.Output.ToScreen},
                        New SqlParameter("pfOutputPrinter", SqlDbType.Bit) With {.Value = objModel.Output.ToPrinter},
                        New SqlParameter("psOutputPrinterName", SqlDbType.VarChar, -1) With {.Value = objModel.Output.PrinterName},
                        New SqlParameter("pfOutputSave", SqlDbType.Bit) With {.Value = objModel.Output.SaveToFile},
                        New SqlParameter("piOutputSaveExisting", SqlDbType.Int) With {.Value = objModel.Output.SaveExisting},
                        New SqlParameter("pfOutputEmail", SqlDbType.Bit) With {.Value = objModel.Output.SendToEmail},
                        New SqlParameter("piOutputEmailAddr", SqlDbType.Int) With {.Value = objModel.Output.EmailGroupID},
                        New SqlParameter("psOutputEmailSubject", SqlDbType.VarChar, -1) With {.Value = objModel.Output.EmailSubject},
                        New SqlParameter("psOutputEmailAttachAs", SqlDbType.VarChar, -1) With {.Value = objModel.Output.EmailAttachmentName},
                        New SqlParameter("psOutputFilename", SqlDbType.VarChar, -1) With {.Value = objModel.Output.Filename},
                        New SqlParameter("psAccess", SqlDbType.VarChar, -1) With {.Value = sAccess},
                        New SqlParameter("psJobsToHide", SqlDbType.VarChar, -1) With {.Value = objModel.Dependencies.JobIDsToHide},
                        New SqlParameter("psJobsToHideGroups", SqlDbType.VarChar, -1) With {.Value = objModel.GroupAccess.HiddenGroups()},
      ...
      Public Function SaveReportDefinition(objModel As NineBoxGridModel) As Boolean
         ...
         Try
            ...
            _objDataAccess.ExecuteSP("spASRIntSaveNineBoxGrid",
                        New SqlParameter("psName", SqlDbType.VarChar, 255) With {.Value = objModel.Name},
                        New SqlParameter("psDescription", SqlDbType.VarChar, -1) With {.Value = objModel.Description},
                        New SqlParameter("piTableID", SqlDbType.Int) With {.Value = objModel.BaseTableID},
                        New SqlParameter("piSelection", SqlDbType.Int) With {.Value = objModel.SelectionType},
                        ...
                        New SqlParameter("pfOutputScreen", SqlDbType.Bit) With {.Value = objModel.Output.ToScreen},
                        New SqlParameter("pfOutputPrinter", SqlDbType.Bit) With {.Value = objModel.Output.ToPrinter},
                        New SqlParameter("psOutputPrinterName", SqlDbType.VarChar, -1) With {.Value = ""},
                        New SqlParameter("pfOutputSave", SqlDbType.Bit) With {.Value = objModel.Output.SaveToFile},
                        New SqlParameter("piOutputSaveExisting", SqlDbType.Int) With {.Value = objModel.Output.SaveExisting},
                        New SqlParameter("pfOutputEmail", SqlDbType.Bit) With {.Value = objModel.Output.SendToEmail},
                        New SqlParameter("piOutputEmailAddr", SqlDbType.Int) With {.Value = objModel.Output.EmailGroupID},
                        New SqlParameter("psOutputEmailSubject", SqlDbType.VarChar, -1) With {.Value = objModel.Output.EmailSubject},
                        New SqlParameter("psOutputEmailAttachAs", SqlDbType.VarChar, -1) With {.Value = objModel.Output.EmailAttachmentName},
                        New SqlParameter("psOutputFilename", SqlDbType.VarChar, -1) With {.Value = ""},
                        New SqlParameter("psAccess", SqlDbType.VarChar, -1) With {.Value = sAccess},
                        New SqlParameter("psJobsToHide", SqlDbType.VarChar, -1) With {.Value = objModel.Dependencies.JobIDsToHide},
                        New SqlParameter("psJobsToHideGroups", SqlDbType.VarChar, -1) With {.Value = objModel.GroupAccess.HiddenGroups()},
                        New SqlParameter("XAxisLabel", SqlDbType.VarChar, 255) With {.Value = objModel.XAxisLabel},
                        New SqlParameter("XAxisSubLabel1", SqlDbType.VarChar, 255) With {.Value = objModel.XAxisSubLabel1},
                        New SqlParameter("XAxisSubLabel2", SqlDbType.VarChar, 255) With {.Value = objModel.XAxisSubLabel2},
                        New SqlParameter("XAxisSubLabel3", SqlDbType.VarChar, 255) With {.Value = objModel.XAxisSubLabel3},
                        New SqlParameter("YAxisLabel", SqlDbType.VarChar, 255) With {.Value = objModel.YAxisLabel},
                        New SqlParameter("YAxisSubLabel1", SqlDbType.VarChar, 255) With {.Value = objModel.YAxisSubLabel1},
                        New SqlParameter("YAxisSubLabel2", SqlDbType.VarChar, 255) With {.Value = objModel.YAxisSubLabel2},
                        New SqlParameter("YAxisSubLabel3", SqlDbType.VarChar, 255) With {.Value = objModel.YAxisSubLabel3},
                        New SqlParameter("Description1", SqlDbType.VarChar, 255) With {.Value = IIf(objModel.Description1 Is Nothing, "", objModel.Description1)},
                        New SqlParameter("ColorDesc1", SqlDbType.VarChar, 6) With {.Value = objModel.ColorDesc1},
                        New SqlParameter("Description2", SqlDbType.VarChar, 255) With {.Value = IIf(objModel.Description2 Is Nothing, "", objModel.Description2)},
                        New SqlParameter("ColorDesc2", SqlDbType.VarChar, 6) With {.Value = objModel.ColorDesc2},
                        New SqlParameter("Description3", SqlDbType.VarChar, 255) With {.Value = IIf(objModel.Description3 Is Nothing, "", objModel.Description3)},
                        New SqlParameter("ColorDesc3", SqlDbType.VarChar, 6) With {.Value = objModel.ColorDesc3},
                        New SqlParameter("Description4", SqlDbType.VarChar, 255) With {.Value = IIf(objModel.Description4 Is Nothing, "", objModel.Description4)},
                        New SqlParameter("ColorDesc4", SqlDbType.VarChar, 6) With {.Value = objModel.ColorDesc4},
                        New SqlParameter("Description5", SqlDbType.VarChar, 255) With {.Value = IIf(objModel.Description5 Is Nothing, "", objModel.Description5)},
                        New SqlParameter("ColorDesc5", SqlDbType.VarChar, 6) With {.Value = objModel.ColorDesc5},
                        New SqlParameter("Description6", SqlDbType.VarChar, 255) With {.Value = IIf(objModel.Description6 Is Nothing, "", objModel.Description6)},
                        New SqlParameter("ColorDesc6", SqlDbType.VarChar, 6) With {.Value = objModel.ColorDesc6},
                        New SqlParameter("Description7", SqlDbType.VarChar, 255) With {.Value = IIf(objModel.Description7 Is Nothing, "", objModel.Description7)},
                        New SqlParameter("ColorDesc7", SqlDbType.VarChar, 6) With {.Value = objModel.ColorDesc7},
                        New SqlParameter("Description8", SqlDbType.VarChar, 255) With {.Value = IIf(objModel.Description8 Is Nothing, "", objModel.Description8)},
                        New SqlParameter("ColorDesc8", SqlDbType.VarChar, 6) With {.Value = objModel.ColorDesc8},
                        New SqlParameter("Description9", SqlDbType.VarChar, 255) With {.Value = IIf(objModel.Description9 Is Nothing, "", objModel.Description9)},
                        New SqlParameter("ColorDesc9", SqlDbType.VarChar, 6) With {.Value = objModel.ColorDesc9},
                        New SqlParameter("piCategoryID", SqlDbType.Int) With {.Value = objModel.CategoryID},
                        prmID)
      ...
      Public Function SaveReportDefinition(objModel As CustomReportModel) As Boolean
         ...
         Try
            ...
            _objDataAccess.ExecuteSP("spASRIntSaveCustomReport",
                        New SqlParameter("psName", SqlDbType.VarChar, 255) With {.Value = objModel.Name},
                        New SqlParameter("psDescription", SqlDbType.VarChar, -1) With {.Value = objModel.Description},
                        New SqlParameter("piBaseTableID", SqlDbType.Int) With {.Value = objModel.BaseTableID},
                        New SqlParameter("pfAllRecords", SqlDbType.Bit) With {.Value = (objModel.PicklistID = 0 AndAlso objModel.FilterID = 0)},
                        New SqlParameter("piPicklistID", SqlDbType.Int) With {.Value = objModel.PicklistID},
                        New SqlParameter("piFilterID", SqlDbType.Int) With {.Value = objModel.FilterID},
                        New SqlParameter("piParent1TableID", SqlDbType.Int) With {.Value = objModel.Parent1.ID},
                        New SqlParameter("piParent1FilterID", SqlDbType.Int) With {.Value = objModel.Parent1.FilterID},
                        New SqlParameter("piParent2TableID", SqlDbType.Int) With {.Value = objModel.Parent2.ID},
                        New SqlParameter("piParent2FilterID", SqlDbType.Int) With {.Value = objModel.Parent2.FilterID},
                        New SqlParameter("pfSummary", SqlDbType.Bit) With {.Value = objModel.IsSummary},
                        New SqlParameter("pfPrintFilterHeader", SqlDbType.Bit) With {.Value = objModel.DisplayTitleInReportHeader},
                        New SqlParameter("psUserName", SqlDbType.VarChar, 255) With {.Value = objModel.Owner},
                        New SqlParameter("pfOutputPreview", SqlDbType.Bit) With {.Value = objModel.Output.IsPreview},
                        New SqlParameter("piOutputFormat", SqlDbType.Int) With {.Value = objModel.Output.Format},
                        New SqlParameter("pfOutputScreen", SqlDbType.Bit) With {.Value = objModel.Output.ToScreen},
                        ...
                        New SqlParameter("psOutputEmailAttachAs", SqlDbType.VarChar, -1) With {.Value = objModel.Output.EmailAttachmentName},
                        New SqlParameter("psOutputFilename", SqlDbType.VarChar, -1) With {.Value = objModel.Output.Filename},
                        New SqlParameter("pfParent1AllRecords", SqlDbType.Bit) With {.Value = (objModel.Parent1.PicklistID = 0 AndAlso objModel.Parent1.FilterID = 0)},
                        New SqlParameter("piParent1Picklist", SqlDbType.Int) With {.Value = objModel.Parent1.PicklistID},
                        New SqlParameter("pfParent2AllRecords", SqlDbType.Bit) With {.Value = (objModel.Parent2.PicklistID = 0 AndAlso objModel.Parent2.FilterID = 0)},
                        New SqlParameter("piParent2Picklist", SqlDbType.Int) With {.Value = objModel.Parent2.PicklistID},
                        New SqlParameter("psAccess", SqlDbType.VarChar, -1) With {.Value = sAccess},
                        New SqlParameter("psJobsToHide", SqlDbType.VarChar, -1) With {.Value = objModel.Dependencies.JobIDsToHide},
                        New SqlParameter("psJobsToHideGroups", SqlDbType.VarChar, -1) With {.Value = objModel.GroupAccess.HiddenGroups()},
                        New SqlParameter("psColumns", SqlDbType.VarChar, -1) With {.Value = sColumns},
                        New SqlParameter("psColumns2", SqlDbType.VarChar, -1) With {.Value = ""},
                        New SqlParameter("psChildString", SqlDbType.VarChar, -1) With {.Value = sChildren},
                        New SqlParameter("piCategoryID", SqlDbType.Int) With {.Value = objModel.CategoryID},
                        prmID,
      ...
      Public Function SaveReportDefinition(objModel As CalendarReportModel) As Boolean
         ...
         Try
            ...
            _objDataAccess.ExecuteSP("spASRIntSaveCalendarReport",
            New SqlParameter("psName", SqlDbType.VarChar, 255) With {.Value = objModel.Name},
                  New SqlParameter("psDescription", SqlDbType.VarChar, -1) With {.Value = objModel.Description},
                  New SqlParameter("piBaseTable", SqlDbType.Int) With {.Value = objModel.BaseTableID},
                  New SqlParameter("pfAllRecords", SqlDbType.Bit) With {.Value = bAllRecords},
                  New SqlParameter("piPicklist", SqlDbType.Int) With {.Value = objModel.PicklistID},
                  New SqlParameter("piFilter", SqlDbType.Int) With {.Value = objModel.FilterID},
                  New SqlParameter("pfPrintFilterHeader", SqlDbType.Bit) With {.Value = objModel.DisplayTitleInReportHeader},
                  New SqlParameter("psUserName", SqlDbType.VarChar, 255) With {.Value = objModel.Owner},
                  New SqlParameter("piDescription1", SqlDbType.Int) With {.Value = objModel.Description1ID},
                  New SqlParameter("piDescription2", SqlDbType.Int) With {.Value = objModel.Description2ID},
                  New SqlParameter("piDescriptionExpr", SqlDbType.Int) With {.Value = objModel.Description3ID},
                  New SqlParameter("piRegion", SqlDbType.Int) With {.Value = objModel.RegionID},
                  New SqlParameter("pfGroupByDesc", SqlDbType.Bit) With {.Value = objModel.GroupByDescription},
                  New SqlParameter("psDescSeparator", SqlDbType.VarChar, 100) With {.Value = sSeparator},
                  New SqlParameter("piStartType", SqlDbType.Int) With {.Value = objModel.StartType},
                  New SqlParameter("psFixedStart", SqlDbType.VarChar) With {.Value = If(objModel.StartFixedDate.HasValue, objModel.StartFixedDate.Value.ToString("yyyy-MM-dd"), "")},
                  New SqlParameter("piStartFrequency", SqlDbType.Int) With {.Value = objModel.StartOffset},
                  New SqlParameter("piStartPeriod", SqlDbType.Int) With {.Value = objModel.StartOffsetPeriod},
                  New SqlParameter("piStartDateExpr", SqlDbType.Int) With {.Value = objModel.StartCustomId},
                  New SqlParameter("piEndType", SqlDbType.Int) With {.Value = objModel.EndType},
                  New SqlParameter("psFixedEnd", SqlDbType.VarChar) With {.Value = If(objModel.EndFixedDate.HasValue, objModel.EndFixedDate.Value.ToString("yyyy-MM-dd"), "")},
                  New SqlParameter("piEndFrequency", SqlDbType.Int) With {.Value = objModel.EndOffset},
                  New SqlParameter("piEndPeriod", SqlDbType.Int) With {.Value = objModel.EndOffsetPeriod},
                  New SqlParameter("piEndDateExpr", SqlDbType.Int) With {.Value = objModel.EndCustomId},
                  New SqlParameter("pfShowBankHols", SqlDbType.Bit) With {.Value = objModel.ShowBankHolidays},
                  New SqlParameter("pfShowCaptions", SqlDbType.Bit) With {.Value = objModel.ShowCaptions},
                  New SqlParameter("pfShowWeekends", SqlDbType.Bit) With {.Value = objModel.ShowWeekends},
                  New SqlParameter("pfStartOnCurrentMonth", SqlDbType.Bit) With {.Value = objModel.StartOnCurrentMonth},
                  New SqlParameter("pfIncludeWorkdays", SqlDbType.Bit) With {.Value = objModel.WorkingDaysOnly},
                  New SqlParameter("pfIncludeBankHols", SqlDbType.Bit) With {.Value = objModel.IncludeBankHolidays},
                  New SqlParameter("pfOutputPreview", SqlDbType.Bit) With {.Value = objModel.Output.IsPreview},
                  New SqlParameter("piOutputFormat", SqlDbType.Int) With {.Value = objModel.Output.Format},
                  New SqlParameter("pfOutputScreen", SqlDbType.Bit) With {.Value = objModel.Output.ToScreen},
                  New SqlParameter("pfOutputPrinter", SqlDbType.Bit) With {.Value = objModel.Output.ToPrinter},
                  ...
                  New SqlParameter("piOutputSaveExisting", SqlDbType.Int) With {.Value = objModel.Output.SaveExisting},
                  New SqlParameter("pfOutputEmail", SqlDbType.Bit) With {.Value = objModel.Output.SendToEmail},
                  New SqlParameter("pfOutputEmailAddr", SqlDbType.Int) With {.Value = objModel.Output.EmailGroupID},
                  New SqlParameter("psOutputEmailSubject", SqlDbType.VarChar, -1) With {.Value = objModel.Output.EmailSubject},
                  New SqlParameter("psOutputEmailAttachAs", SqlDbType.VarChar, -1) With {.Value = objModel.Output.EmailAttachmentName},
                  New SqlParameter("psOutputFilename", SqlDbType.VarChar, -1) With {.Value = objModel.Output.Filename},
                  New SqlParameter("psAccess", SqlDbType.VarChar, -1) With {.Value = sAccess},
                  New SqlParameter("psJobsToHide", SqlDbType.VarChar, -1) With {.Value = objModel.Dependencies.JobIDsToHide},
                  New SqlParameter("psJobsToHideGroups", SqlDbType.VarChar, -1) With {.Value = objModel.GroupAccess.HiddenGroups()},
                  New SqlParameter("psEvents", SqlDbType.VarChar, -1) With {.Value = sEvents},
                  New SqlParameter("psEvents2", SqlDbType.VarChar, -1) With {.Value = ""},
                  New SqlParameter("psOrderString", SqlDbType.VarChar, -1) With {.Value = sReportOrder},
                  New SqlParameter("piCategoryID", SqlDbType.Int) With {.Value = objModel.CategoryID},
                  prmID)
      ...
      Public Function SaveReportDefinition(objModel As TalentReportModel) As Boolean
         ...
         Try
            ...
            _objDataAccess.ExecuteSP("spASRIntSaveTalentReport",
                        New SqlParameter("psName", SqlDbType.VarChar, 255) With {.Value = objModel.Name},
                        New SqlParameter("psDescription", SqlDbType.VarChar, -1) With {.Value = objModel.Description},
                        New SqlParameter("piBaseTableID", SqlDbType.Int) With {.Value = objModel.BaseTableID},
                        New SqlParameter("piBaseSelection", SqlDbType.Int) With {.Value = objModel.SelectionType},
                        New SqlParameter("piBasePicklistID", SqlDbType.Int) With {.Value = objModel.PicklistID},
                        New SqlParameter("piBaseFilterID", SqlDbType.Int) With {.Value = objModel.FilterID},
                        New SqlParameter("piBaseChildTableID", SqlDbType.Int) With {.Value = objModel.BaseChildTableID},
                        New SqlParameter("piBaseChildColumnID", SqlDbType.Int) With {.Value = objModel.BaseChildColumnID},
                        New SqlParameter("piBaseMinimumRatingColumnID", SqlDbType.Int) With {.Value = objModel.BaseMinimumRatingColumnID},
                        New SqlParameter("piBasePreferredRatingColumnID", SqlDbType.Int) With {.Value = objModel.BasePreferredRatingColumnID},
                        New SqlParameter("piMatchTableID", SqlDbType.Int) With {.Value = objModel.MatchTableID},
                        New SqlParameter("piMatchSelection", SqlDbType.Int) With {.Value = CInt(objModel.MatchSelectionType)},
                        New SqlParameter("piMatchPicklistID", SqlDbType.Int) With {.Value = objModel.MatchPicklistID},
                        New SqlParameter("piMatchFilterID", SqlDbType.Int) With {.Value = objModel.MatchFilterID},
                        New SqlParameter("piMatchChildTableID", SqlDbType.Int) With {.Value = objModel.MatchChildTableID},
                        New SqlParameter("piMatchChildColumnID", SqlDbType.Int) With {.Value = objModel.MatchChildColumnID},
                        New SqlParameter("piMatchChildRatingColumnID", SqlDbType.Int) With {.Value = objModel.MatchChildRatingColumnID},
                        New SqlParameter("piMatchAgainstType", SqlDbType.Int) With {.Value = objModel.MatchAgainstType},
                        New SqlParameter("pbIncludeUnmatched", SqlDbType.Bit) With {.Value = objModel.IncludeUnmatched},
                        New SqlParameter("piMinimumScore", SqlDbType.Int) With {.Value = objModel.MinimumScore},
                        New SqlParameter("psUserName", SqlDbType.VarChar, 255) With {.Value = objModel.Owner},
                        New SqlParameter("psAccess", SqlDbType.VarChar, -1) With {.Value = sAccess},
                        New SqlParameter("psJobsToHide", SqlDbType.VarChar, -1) With {.Value = objModel.Dependencies.JobIDsToHide},
                        New SqlParameter("psJobsToHideGroups", SqlDbType.VarChar, -1) With {.Value = objModel.GroupAccess.HiddenGroups()},
      ...
      Public Function RetrieveOrganisationReport(id As Integer) As OrganisationReportModel

         Try
            Return _organisationreports.Where(Function(m) m.ID = id).FirstOrDefault

         Catch ex As Exception
            Return New OrganisationReportModel
      ...
      Public Function ServerValidate(objModel As CalendarReportModel) As SaveWarningModel
         ...
         Try
            ...
            _objDataAccess.ExecuteSP("spASRIntValidateCalendarReport",
                        New SqlParameter("psUtilName", SqlDbType.VarChar, 255) With {.Value = objModel.Name},
                        New SqlParameter("piUtilID", SqlDbType.Int) With {.Value = objModel.ID},
                        New SqlParameter("piTimestamp", SqlDbType.Int) With {.Value = objModel.Timestamp},
                        New SqlParameter("piBasePicklistID", SqlDbType.Int) With {.Value = objModel.PicklistID},
                        New SqlParameter("piBaseFilterID", SqlDbType.Int) With {.Value = objModel.FilterID},
                        New SqlParameter("piEmailGroupID", SqlDbType.Int) With {.Value = objModel.Output.EmailGroupID},
                        New SqlParameter("piDescExprID", SqlDbType.Int) With {.Value = objModel.Description3ID},
                        New SqlParameter("psEventFilterIDs", SqlDbType.VarChar, -1) With {.Value = objModel.Dependencies.EventFilters},
                        New SqlParameter("piCustomStartID", SqlDbType.Int) With {.Value = objModel.StartCustomId},
                        New SqlParameter("piCustomEndID", SqlDbType.Int) With {.Value = objModel.EndCustomId},
                        New SqlParameter("piCategoryID", SqlDbType.Int) With {.Value = objModel.CategoryID},
                        New SqlParameter("psHiddenGroups ", SqlDbType.VarChar, -1) With {.Value = objModel.GroupAccess.HiddenGroups()},
                        prmErrorMsg, prmErrorCode, prmDeletedFilters, prmHiddenFilters,
      ...
      Public Function ServerValidate(objModel As CrossTabModel) As SaveWarningModel
         ...
         Try
            ...
            _objDataAccess.ExecuteSP("spASRIntValidateCrossTab",
                                    New SqlParameter("psUtilName", SqlDbType.VarChar, 255) With {.Value = objModel.Name},
                                    New SqlParameter("piUtilID", SqlDbType.Int) With {.Value = objModel.ID},
                                    New SqlParameter("piTimestamp", SqlDbType.Int) With {.Value = objModel.Timestamp},
                                    New SqlParameter("piBasePicklistID", SqlDbType.Int) With {.Value = objModel.PicklistID},
      ...
      Public Function ServerValidate(objModel As NineBoxGridModel) As SaveWarningModel
         ...
         Try
            ...
            _objDataAccess.ExecuteSP("spASRIntValidateNineBoxGrid",
                                    New SqlParameter("psUtilName", SqlDbType.VarChar, 255) With {.Value = objModel.Name},
                                    New SqlParameter("piUtilID", SqlDbType.Int) With {.Value = objModel.ID},
                                    New SqlParameter("piTimestamp", SqlDbType.Int) With {.Value = objModel.Timestamp},
                                    New SqlParameter("piBasePicklistID", SqlDbType.Int) With {.Value = objModel.PicklistID},
      ...
      Public Function ServerValidate(objModel As CustomReportModel) As SaveWarningModel
         ...
         Try
            ...
            _objDataAccess.ExecuteSP("spASRIntValidateCustomReport",
                                    New SqlParameter("@psUtilName", SqlDbType.VarChar) With {.Value = objModel.Name, .Size = 255},
                                    New SqlParameter("@piUtilID", SqlDbType.Int) With {.Value = objModel.ID},
                                    New SqlParameter("@piTimestamp", SqlDbType.Int) With {.Value = objModel.Timestamp},
                                    New SqlParameter("@piBasePicklistID", SqlDbType.Int) With {.Value = objModel.PicklistID},
                                    New SqlParameter("@piBaseFilterID", SqlDbType.Int) With {.Value = objModel.FilterID},
                                    New SqlParameter("@piEmailGroupID", SqlDbType.Int) With {.Value = objModel.Output.EmailGroupID},
                                    New SqlParameter("@piParent1PicklistID", SqlDbType.Int) With {.Value = objModel.Parent1.PicklistID},
                                    New SqlParameter("@piParent1FilterID", SqlDbType.Int) With {.Value = objModel.Parent1.FilterID},
                                    New SqlParameter("@piParent2PicklistID", SqlDbType.Int) With {.Value = objModel.Parent2.PicklistID},
                                    New SqlParameter("@piParent2FilterID", SqlDbType.Int) With {.Value = objModel.Parent2.FilterID},
                                    New SqlParameter("@piChildFilterID", SqlDbType.VarChar) With {.Value = objModel.Dependencies.ChildFilters, .Size = 100},
                                    New SqlParameter("@psCalculations", SqlDbType.VarChar) With {.Value = objModel.Dependencies.Calculations, .Size = -1},
                                    New SqlParameter("@piCategoryID", SqlDbType.Int) With {.Value = objModel.CategoryID},
                                    New SqlParameter("@psHiddenGroups ", SqlDbType.VarChar) With {.Value = objModel.GroupAccess.HiddenGroups(), .Size = -1},
                                    prmErrorMsg, prmErrorCode, prmDeletedCalcs, prmHiddenCalcs, prmDeletedFilters, prmHiddenFilters, prmDeletedOrders,
      ...
      Friend Function GetViewFilterColumns(viewId As Integer) As List(Of ReportColumnItem)
         ...
         Dim objOrgViewColumns As New List(Of ReportColumnItem)
         ...
         Try
            ...
            For Each objRow As DataRow In dtViewColumns.Rows
               ...
               objOrgViewColumns.Add(New ReportColumnItem() With {
                  ...
                  .ViewID = viewId,
                  .ViewName = Convert.ToString(psRealSource.Value),
                  .ColumnID = CInt(objRow("columnID")),
                  .Name = Replace(objRow("columnName").ToString, "_", " "),
                  .DataType = CType(CInt(objRow("dataType")), ColumnDataType),
                  .Size = CInt(objRow("size")),
                  .Decimals = CInt(objRow("decimals"))})
         ...
         Try
            ...
            For Each objRow As DataRow In data.Rows
               ...
               Dim objItem As New ReportColumnItem() With {
                ...
                .Prefix = HttpUtility.HtmlDecode(objRow("Prefix").ToString),
                .Suffix = HttpUtility.HtmlDecode(objRow("Suffix").ToString),
      ...
      ' Save Organisation report definition
      ...
      ' Validate Organisation Report before saving the definition
      ...
      'get columns for selected BaseView in definiton screen and populate fields in filter tab.
