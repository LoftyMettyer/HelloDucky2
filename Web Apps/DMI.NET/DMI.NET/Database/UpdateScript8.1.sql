...
/* Changes needed to ASRSysCrossTab table for nine Box Grid to work*/ 
IF EXISTS (SELECT *	FROM dbo.sysobjects	WHERE id = object_id(N'[dbo].[ASRSysCrossTab]') AND xtype in (N'U'))
	DROP TABLE [ASRSysCrossTab]
GO
...
/* End of Expression Builder proc */
