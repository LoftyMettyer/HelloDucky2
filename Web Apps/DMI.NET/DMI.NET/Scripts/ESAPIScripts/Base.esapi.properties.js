...
Base.esapi.properties = {
    ...
    openHRValidationBlackList: {
    	AllInvalidCharacters: '[()<>]',
    	AllowOnlyInteger: '^[0-9]+$'
			//Add other black list filters
    },

    openHRValidationMessages: {
			AllInvalidCharacters: 'Invalid input. Please enter valid input.',
    	AllowOnlyInteger: 'Invalid integer value. Please enter valid input.',
    	AllowOnlyNumeric:'Invalid numeric value. Please enter valid input.'
    }
};