/*
	...
	[RC 15/10/2013] - Modified regexp definitions in the plugin to match the mask functionality of OpenHR 5.1
*/
(function ($) {
  ...
  $.mask = {
    ...
    definitions: {
      ...
      's': "[a-z ]",
      'S': "[A-Z ]",
      '#': "[£$%+,. 0-9-\\\\]" // The symbols # should accept (as per Mark Edwynn's instructions) are: £$%+-\,.[space] and numbers
    },
    dataName: "rawMaskFn",
    placeholder: '_',
  };
