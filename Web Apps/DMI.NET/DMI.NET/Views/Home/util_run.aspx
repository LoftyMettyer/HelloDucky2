...
<%
    If Session("utiltype") = "1" Then
        Response.Write("    <frame name=""main"" src=""util_run_crosstabsMain"">" & vbCrLf)
    ElseIf Session("utiltype") = "2" Then
        Response.Write("    <frame name=""main"" src=""util_run_customreportsMain"">" & vbCrLf)
    ElseIf Session("utiltype") = "3" Then
        Response.Write("    <frame name=""main"" src=""util_run_datatransfer"">" & vbCrLf)
    ElseIf Session("utiltype") = "4" Then
        Response.Write("    <frame name=""main"" src=""util_run_export"">" & vbCrLf)
    ElseIf Session("utiltype") = "5" Then
        Response.Write("    <frame name=""main"" src=""util_run_globaladd"">" & vbCrLf)
    ElseIf Session("utiltype") = "6" Then
        Response.Write("    <frame name=""main"" src=""util_run_globalupdate"">" & vbCrLf)
    ElseIf Session("utiltype") = "7" Then
        Response.Write("    <frame name=""main"" src=""util_run_globaldelete"">" & vbCrLf)
    ElseIf Session("utiltype") = "8" Then
        Response.Write("    <frame name=""main"" src=""util_run_import"">" & vbCrLf)
    ElseIf Session("utiltype") = "9" Then
        Response.Write("    <frame name=""main"" src=""util_run_mailmerge"">" & vbCrLf)
    ElseIf Session("utiltype") = "15" Then
        Response.Write("    <frame name=""main"" src=""stdrpt_run_AbsenceBreakdown"">" & vbCrLf)
    ElseIf Session("utiltype") = "16" Then
        Response.Write("    <frame name=""main"" src=""util_run_customreportsMain"">" & vbCrLf)
    ElseIf Session("utiltype") = "17" Then
        Response.Write("    <frame name=""main"" src=""util_run_calendarreport_main"">" & vbCrLf)
    End If
