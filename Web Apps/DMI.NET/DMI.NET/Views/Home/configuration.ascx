...
<script type="text/javascript">
    function configuration_window_onload() {
        ...
        frmConfiguration.chkOwner_ORGREPORTING.checked = (frmOriginalConfiguration.txtOnlyMineORGREPORTING.value == 1);
...
<script type="text/javascript">
    ...
    function saveConfiguration() {
        ...
        if (frmConfiguration.chkOwner_ORGREPORTING.checked == true) frmConfiguration.txtOwner_ORGREPORTING.value = 1;
    ...
    function restoreDefaults() {
        ...
        if (answer == 6) {
            ...
            frmConfiguration.chkOwner_ORGREPORTING.checked = false;
...
<form action="Configuration_Submit" onsubmit="return false;" method="post" id="frmConfiguration" name="frmConfiguration">
                ...
                <td>
                    <table class="invisible">
                        ...
                        <tr>
                            ...
                            <td style="width: 20px"></td>
                            <td align="left" nowrap>
                                <input type="checkbox" id="chkOwner_ORGREPORTING" name="chkOwnerORGREPORTING" />
                                <label for="chkOwner_ORGREPORTING" class="checkbox">Organisation Reports</label>
                            </td>
                            <td colspan="4"></td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="6">
                                <input id="btnDiv2Restore" name="btnDiv2Restore" type="button" class="btn floatright" value="Restore Defaults"  onclick="restoreDefaults()" />
    ...
    <input type="hidden" id="txtOwner_ORGREPORTING" name="txtOwner_ORGREPORTING" value="0">
...
<form id="frmOriginalConfiguration" name="frmOriginalConfiguration">
    ...
    <input type="hidden" id="txtOnlyMineORGREPORTING" name="txtOnlyMineORGREPORTING" value='<%=Session("onlyMine ORGREPORTING")%>'>
