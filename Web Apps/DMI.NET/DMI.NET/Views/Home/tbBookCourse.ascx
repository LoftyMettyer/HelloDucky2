...
<!--
	...
	if (fOK == true) {
		...
		//		optionDataForm.txtOptionCourseTitle.value = frmFindForm.txtOptionCourseTitle.value;
...
<FORM action="tbBookCourseFind_Submit.asp" method=post id=frmGotoOption name=frmGotoOption>
