...
<script>
    ...
    $(document).ready(function () {
        ...
        //When we do Save to File and when the font-color of title is in White color then set it to black color.
        if($("#textSaveToFileTitle").css("color") == "rgb(255, 255, 255)"){
            $("#textSaveToFileTitle").css("color","black");
        }
    }); //--------------End Ready ---------------
...
<div id="divSaveToFileParent" style="display:none;position:absolute;z-index:-10000;background-color:white;">
    <h2 id="textSaveToFileTitle" style="margin-left:20px;">Organisation Report : @Session("utilname")</h2>
