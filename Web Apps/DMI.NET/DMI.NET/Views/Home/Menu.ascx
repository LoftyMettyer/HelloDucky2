...
<%
   ...
   Dim iOrganisationChartGranted As Integer = 0
   ...
   Response.Write("<input type='hidden' id=txtOrganisationChartGranted name=txtOrganisationChartGranted value=" & IIf(SettingsConfig.isOrgChartEnabled = -1, "0", "1") & ">")
