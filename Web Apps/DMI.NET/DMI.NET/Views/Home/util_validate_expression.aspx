...
%>				
						...
						<br />		
						<br />		
						<input type="button" value="Cancel" class="btn" name="Cancel" style="width: 80px" id="Cancel" onclick="uve_cancelClick()" />
					</div>
<%
	Dim fOK As Boolean
	...
	If Request.Form("validatePass") = 1 Then
		...
		If (iErrorCode = 1) Or (iErrorCode = 2) Then
			...
			Response.Write("    				    <input type='button' value='No' class='btn' name='btnNo' style='width: 80px' id='btnNo'" & vbCrLf)
						                                                                                                                           			 Response.Write("    				        OnClick=""uve_cancelClick()""/>" & vbCrLf)
						                                                                                                                           			 Response.Write("			    </td>" & vbCrLf)
						                                                                                                                           			 Response.Write("					<td width='20'></td>" & vbCrLf)
						                                                                                                                           			 Response.Write("			  </tr>" & vbCrLf)
						                                                                                                                           		 End If
						                                                                                                                           		 ...
						                                                                                                                           		 If iErrorCode = 4 Then
						                                                                                                                           			 ...
						                                                                                                                           			 Response.Write("    <input type='button' value='Close' class='btn' name='Cancel' style='width: 80px' id='Cancel' OnClick='uve_cancelClick()'/>" & vbCrLf)
						                                                                                                                           			 Response.Write("	</div>")
						                                                                                                                           		 End If
