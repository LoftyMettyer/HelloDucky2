								...
								<td height="10" colspan="5" align="left" valign="top">
									<table class="invisible" cellspacing="0" cellpadding="0" width="100%">
										<tr height="5">
											...
											<td width="5"></td>
											<td id="tdEventName" name="tdEventName" valign="top"></td>
											<td width="5"></td>
										</tr>
										<tr height="5">
											<td colspan="5"></td>
										...
										<tr height="5">
											...
											<td width="5"></td>
											<td id="tdBaseDesc" name="tdBaseDesc" valign="top"></td>
											<td width="5"></td>
										</tr>
										<tr height="5">
											<td colspan="5">
										...
										<tr height="5">
											...
											<td width="5"></td>
											<td id="tdStartDate" name="tdStartDate" valign="top"></td>
											<td width="5"></td>
										</tr>
										<tr height="5">
											<td colspan="5"></td>
										...
										<tr height="5">
											...
											<td width="5"></td>
											<td id="tdEndDate" name="tdEndDate" valign="top"></td>
											<td width="5"></td>
										</tr>
										<tr height="5">
											<td colspan="5"></td>
										...
										<tr height="5">
											...
											<td width="5"></td>
											<td id="tdDuration" name="tdDuration" valign="top"></td>
											<td width="5"></td>
										</tr>
										<tr height="5">
											<td colspan="5">
										...
										<tr height="5">
											...
											<td width="5"></td>
											<td id="tdEventDesc1Value" name="tdEventDesc1Value" valign="top"></td>
											<td width="5"></td>
										</tr>
										<tr height="5">
											<td colspan="5"></td>
										...
										<tr height="5">
											...
											<td width="5"></td>
											<td id="tdCalendarCode" name="tdCalendarCode" valign="top"></td>
											<td width="5"></td>
										</tr>
										<% 
