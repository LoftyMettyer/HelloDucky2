...
function refreshControls() {			
	...
	button_disable(frmDefSel.cmdEdit, (fNoneSelected || ((frmpermissions.grantedit.value == 0) && (frmpermissions.grantview.value == 0))));
	button_disable(frmDefSel.cmdNew, (frmpermissions.grantnew.value == 0));
	button_disable(frmDefSel.cmdCopy, (fNoneSelected || (frmpermissions.grantnew.value == 0)));
	button_disable(frmDefSel.cmdDelete, (fNoneSelected || (frmpermissions.grantdelete.value == 0) || (frmDefSel.cmdEdit.value.toUpperCase() == "VIEW")));
			
	if (((frmpermissions.grantedit.value == 0) && (frmpermissions.grantview.value == 1)) || (frmDefSel.cmdEdit.value.toUpperCase() == "VIEW")) {
		frmDefSel.cmdEdit.value = "View";
					...
					<tr>
							<td width="100%">
									<table height="100%" width="100%">
											...
											<tr>
													<td height="70">
															<textarea cols="20" class="disabled" style="WIDTH: 100%;" name="txtDescription" rows="4" readonly="readonly" tabindex="-1"></textarea>
													</td>
											</tr>
									</table>
							</td>
