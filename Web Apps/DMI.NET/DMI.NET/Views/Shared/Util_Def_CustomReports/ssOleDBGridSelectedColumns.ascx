...
<OBJECT classid="clsid:4A4AA697-3E6F-11D2-822F-00104B9E07A1" 
	...
	style="HEIGHT: 100%; VISIBILITY: visible; WIDTH: 100%; LEFT: 0px; TOP: 0px" width=100% height=100%>
	...
	<PARAM NAME="Columns(12).Caption" VALUE="hiddencolumn">
	<PARAM NAME="Columns(12).Name" VALUE="hiddencolumn">
