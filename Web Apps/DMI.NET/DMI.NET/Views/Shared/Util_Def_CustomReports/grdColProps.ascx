...
<OBJECT id=grdColProps style="LEFT: 0px; VISIBILITY: visible; WIDTH: 0px; TOP: 0px; HEIGHT: 0px; " 
	codeBase=cabs/COAInt_Grid.cab#version=3,1,3,6 height=0 width=0 classid="clsid:4A4AA697-3E6F-11D2-822F-00104B9E07A1" 
	name=grdColProps VIEWASTEXT>
	...
	<PARAM NAME="Columns.Count" VALUE="7">
	
	<PARAM NAME="Columns(0).Width" VALUE="2000">
	<PARAM NAME="Columns(0).Visible" VALUE="-1">
	<PARAM NAME="Columns(0).Columns.Count" VALUE="1">
	<PARAM NAME="Columns(0).Caption" VALUE="ColumnID">
	...
	<PARAM NAME="Columns(1).Width" VALUE="2000">
	<PARAM NAME="Columns(1).Visible" VALUE="-1">
	<PARAM NAME="Columns(1).Columns.Count" VALUE="1">
	<PARAM NAME="Columns(1).Caption" VALUE="Hidden">
	<PARAM NAME="Columns(1).Name" VALUE="Hidden">
