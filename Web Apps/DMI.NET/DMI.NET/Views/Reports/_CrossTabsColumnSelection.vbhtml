	...
	<fieldset>
		<table class="width100">
			...
			<tr>
				...
				<td>
					@Html.ColumnDropdownFor(Function(m) m.HorizontalID, New ColumnFilter() With {.TableID = Model.BaseTableID, .ExcludeOle = True}, New With {.onchange = "crossTabHorizontalChange()", .class = "enableSaveButtonOnComboChange"})
			...
			<tr>
				<td>Vertical :</td>
				<td>
					@Html.ColumnDropdownFor(Function(m) m.VerticalID, New ColumnFilter() With {.TableID = Model.BaseTableID, .ExcludeOle = True}, New With {.onchange = "crossTabVerticalChange()", .class = "enableSaveButtonOnComboChange"})
