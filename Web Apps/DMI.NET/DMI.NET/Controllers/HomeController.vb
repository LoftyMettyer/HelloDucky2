...
#End Region
		...
		Public Sub SaveSessionVariableState(windowId As Integer)

			Dim sessionVariables = CType(Session("SessionVariables"), SessionVariablesCollection)
			sessionVariables.UpdateState(windowId)
			Session("SessionVariables") = sessionVariables

		End Sub

		Public Sub RestoreSessionVariableState(windowId As Integer)

			Dim sessionVariables = CType(Session("SessionVariables"), SessionVariablesCollection)
			sessionVariables.RestoreState(windowId)
