...
#End Region
      ...
      Function newUser_Submit(value As NewUserModel) As JsonResult
         ...
         Try
            objDataAccess.ExecuteSP("sp_ASRIntNewUser",
      ...
      Function GetFindRecordByID(RecordID As Integer) As String
         ...
         SPParameters = New SqlParameter() {
               prmError,
               prmSomeSelectable,
               prmSomeNotSelectable,
               prmRealSource,
               prmInsertGranted,
               prmDeleteGranted,
               ...
               New SqlParameter("@piOrderID ", SqlDbType.Int) With {.Value = CleanNumeric(Session("orderID"))},
               ...
               New SqlParameter("@psFilterDef", SqlDbType.VarChar, -1) With {.Value = filterDefForCurrentTable},
               New SqlParameter("@piRecordsRequired", SqlDbType.Int) With {.Value = 10000000},
               prmIsFirstPage,
               prmIsLastPage,
               New SqlParameter("@psLocateValue", SqlDbType.VarChar, -1) With {.Value = Session("locateValue")},
               prmColumnType,
               prmColumnSize,
               prmColumnDecimals,
               New SqlParameter("@psAction", SqlDbType.VarChar) With {.Value = Session("action"), .Size = 255},
               prmTotalRecCount,
               prmFirstRecPos,
               New SqlParameter("@piCurrentRecCount", SqlDbType.Int) With {.Value = CleanNumeric(Session("currentRecCount"))},
               New SqlParameter("@psDecimalSeparator", SqlDbType.VarChar, 255) With {.Value = Session("LocaleDecimalSeparator")},
               New SqlParameter("@psLocaleDateFormat", SqlDbType.VarChar, 255) With {.Value = Platform.LocaleDateFormatForSQL()},
               New SqlParameter("@RecordID", SqlDbType.Int) With {.Value = RecordID},
      ...
      Function GetSummaryColumns(parentTableID As String, parentRecordID As String) As String
         ...
         Dim objDataAccess As New clsDataAccess(objSession.LoginInfo) 'Instantiate DataAccess class
         SPParameters = New SqlParameter() {
            New SqlParameter("@piHistoryTableID", SqlDbType.Int) With {.Value = CleanNumeric(Session("tableID"))},
            New SqlParameter("@piParentTableID", SqlDbType.Int) With {.Value = parentTableID},
            New SqlParameter("@piParentRecordID", SqlDbType.Int) With {.Value = parentRecordID}
         }
      ...
      Function Find(Optional sParameters As String = "") As ActionResult
         ...
         If sParameters.Length > 0 Then
            ...
            If Len(sErrorDescription) = 0 Then
               ...
               If (Session("linkType") <> "multifind") And
            ...
            If (Len(sErrorDescription) = 0) Then
               ...
               If (NullSafeInteger(Session("SSILinkViewID")) = NullSafeInteger(Session("SingleRecordViewID")) Or
                  (Session("linkType") = "multifind")) And
...
#End Region
      ...
      Public Sub ShowImageFromDb(imageID As String)
         ...
         Try
            objRs = objDataAccess.GetFromSP("spASRIntGetPicture",
      ...
      Function GetChartDataAsHTML(
         ...
         Script = String.Concat("<script type='text/javascript'>",
         ...
         Catch ex As Exception
            ...
            Else
               strErrors = String.Format("The following error occured when emailing your document:" _
                  & "{0}{0}{1}{0}{0}{2}{0}{0}Please check with your administrator for further details.", "<br/>",
         ...
         Try
            ...
            If value.PromptValues IsNot Nothing Then
               For Each objPrompt In value.PromptValues
                  sKey = objPrompt.Key
                  If ((UCase(Left(sKey, 7)) = "PROMPT_") And (Mid(sKey, 8, 1) <> "3")) Or
                  ...
                  For intCol = 3 To 5
                     For intRow = 5 To 3 Step -1
                        ClientDLL.ArrayAddToNineBoxGrid(
                                                                        intCol - 3,
                                                                        intRow - 3,
                                                                        objCrossTab.ReturnDescriptionOrColourForNineBoxGridCell(intCol - 3, intRow - 3, CrossTab.enumNineBoxDescriptionOrColour.Description),
                                                                        HttpUtility.HtmlDecode(Left(objCrossTab.DataArray(intCol, intRow), 255)),
      ...
      Function util_def_expression_Submit(value As SubmitExpressionModel)
         ...
         Try
            ...
            If fok Then
               ...
               If fok Then
                  If (value.txtSend_access = "HD") And
...
#Region "Picklists"
      ...
      Function util_def_picklist_submit()
         Try
            ...
            objDataAccess.ExecuteSP("sp_ASRIntSavePicklist",
               New SqlParameter("psName", SqlDbType.VarChar, 255) With {.Value = Request.Form("txtSend_name")},
               New SqlParameter("psDescription", SqlDbType.VarChar, -1) With {.Value = Request.Form("txtSend_description")},
               New SqlParameter("psAccess", SqlDbType.VarChar, -1) With {.Value = Request.Form("txtSend_access")},
               New SqlParameter("psUserName", SqlDbType.VarChar, 255) With {.Value = Request.Form("txtSend_userName")},
               New SqlParameter("psColumns", SqlDbType.VarChar, -1) With {.Value = Request.Form("txtSend_columns") & ","},
               New SqlParameter("psColumns2", SqlDbType.VarChar, -1) With {.Value = Request.Form("txtSend_columns2")},
               prmID,
         ...
         If postData.Action = OptionActionType.SELECTBOOKCOURSE_2 Then
            If postData.Key2 > 0 Then
               ...
               Try
                  ...
                  objDataAccess.ExecuteSP("sp_ASRIntGetEmpIDFromWLID",
                        prmTBEmployeeRecordID,
...
#Region "OrganisationReports"
      ...
      Public Function OrganisationReports(value As PromptedValuesModel) As PartialViewResult
         ...
         Try
            ...
            objErrorLog.ChangeHeaderStatus(EventLog_Status.elsSuccessful)
         Catch ex As Exception
            objErrorLog.ChangeHeaderStatus(EventLog_Status.elsFailed)
            objErrorLog.AddDetailEntry(ex.Message)
            Throw
         End Try
      ...
      Private Function LoadDataForOrganisationReport(IsPostBasedSystem As Boolean) As List(Of OrgReportChartNode)
         ...
         If iLoggedInUser = 0 Then
            Session("ErrorText") = "Current user not identified."
            Return orgCharts
         End If
                  ...
                  ColumnList.Add(New ReportColumnItem() With
                                    {
                                        ...
                                        .Heading = HttpUtility.HtmlEncode(objRow("ColumnName").ToString()),
                                        ...
                                        .Height = Convert.ToInt32(CInt(objRow("Height")) * Math.Round(CInt(objRow("FontSize")) * 1.5)),
                                        .Decimals = CInt(objRow("Decimals")),
                                        .IsGroupWithNext = CBool(objRow("ConcatenateWithNext")),
                                        .DefaultHeight = CInt(objRow("Height")),
               ...
               For Each objRow As DataRow In OrgReportRecords.Tables(0).Rows
                  ...
                  For Each columnitem As ReportColumnItem In cloneList
                     ...
                     Else
                        ...
                        If Not IsDBNull(objRow(strColumnName)) And OrgReportRecords.Tables(0).Columns(strColumnName).DataType.Name.ToLower = "byte[]" Then

                           Dim imageBytes = CType(objRow(strColumnName), Byte())

                           Dim oleType As Short = Val(Encoding.UTF8.GetString(imageBytes, 8, 2))

                           If oleType = 2 Then 'Embeded
                              Dim abtImage = imageBytes
                              ...
                              Try
                                 ...
                                 img = img.GetThumbnailImage(columnitem.Height, columnitem.Height, Nothing, IntPtr.Zero)
                        ...
                        columnitem.ColumnValue = photoSource
                     End If
                  Next
...
#Region "PostBased System"
               ...
               If (IsPostBasedSystem) Then
                  'Group the data based on Post_ID column.
                  ...
                  For Each item As OrgReportChartNode In postList
                     ...
                     If IsDBNull(item.PostWiseNodeList) = False AndAlso item.PostWiseNodeList.Count > 0 Then
                        ...
                        item.LineManagerStaffNo = firstEmp.LineManagerStaffNo
                        item.HierarchyLevel = firstEmp.HierarchyLevel
                        item.PostTitle = firstEmp.PostTitle
                        item.ReportColumnItemList = firstEmp.ReportColumnItemList
                        item.PostID = firstEmp.PostID
                     End If
                  Next
...
#End Region
         ...
         Catch ex As SqlException
            ...
            Select Case ex.Number
               Case 2812
                  sErrorDescription = "The required setup for your organisation report has not been completed."
               Case 217
            ...
            End Select
            Session("ErrorText") = sErrorDescription
      ...
      Friend Function ProcessColumnsForOrgReport(Columns As List(Of ReportColumnItem), IsPostBasedSystem As Boolean) As List(Of ReportColumnItem)
         ...
         Dim PreviewColumnList As New List(Of ReportColumnItem)
         Dim BaseViewColumns As New List(Of ReportColumnItem)

         'Sort the data
         If IsPostBasedSystem Then
            BaseViewColumns = Columns.FindAll(Function(x) x.TableID = SettingsConfig.Hierarchy_TableID)
