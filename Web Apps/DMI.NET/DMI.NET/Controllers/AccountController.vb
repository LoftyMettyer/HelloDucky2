   ...
   Public Class AccountController
      ...
      Public Function ActualLogin(linkRef As String, Optional portalRedirectTo As String = "") As ActionResult
         Try
            ...
            'Assign disablesimple chart parameter value
            SettingsConfig.isOrgChartEnabled = CInt(objDataAccess.GetModuleSetting("MODULE_HIERARCHY", "Param_DisableSimpleChart", "PType_Other"))
      ...
      Function ForgotPassword_Submit(value As ForgotPasswordModel) As ActionResult
         ...
         Try
            ...
            If value.txtVerify Is Nothing OrElse Not value.txtVerify.Equals(Session("CaptchaText").ToString(), StringComparison.OrdinalIgnoreCase) Then
