<%@ Page Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="ThemeTransparent.aspx.cs" 
Inherits="SchedulerDefault" Title="Transparent CSS Theme (Scheduler) | DayPilot Lite for ASP.NET WebForms Demo" %>
...
<DayPilot:DayPilotScheduler ID="DayPilotScheduler1" runat="server" 
        ...
        CssOnly="true"
        CssClassPrefix="scheduler_transparent"
        EventHeight="30"
        >
        <Resources>
