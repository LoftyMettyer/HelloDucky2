...
Private Sub cboTableValue_Refresh()
  ...
  Dim fOK As Boolean
  Dim sSQL As String
  Dim rsLookupValues As ADODB.Recordset
  Dim rsColumnInfo As ADODB.Recordset
  ...
  Set rsColumnInfo = modExpression.OpenRecordset(sSQL, adOpenForwardOnly, adLockReadOnly)
  With rsColumnInfo
    fOK = Not (.EOF And .BOF)
...
Private Sub InitializeControls()
  ...
  Const XGAP = 100
  Const YGAP = 200
  Const MAXFORMWIDTH = 7000
  Const MINFORMWIDTH = 1600
  ...
  Select Case mobjComponent.valueType
    ...
    Case giEXPRVALUE_NUMERIC
      With TDBNumericValue
        ...
        FormatTDBNumberControl TDBNumericValue
