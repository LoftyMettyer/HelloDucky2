...
Private Function SetupTablesCollection(pobjGroup As SecurityGroup) As Boolean
  ...
  Dim sRealSourceList As New HrProSecurityMgr.clsStringBuilder
...
Private Function ApplyChanges_TidyChildTablePermissions() As Boolean
  ...
  Dim sSysSecMgrRoleList As New HrProSecurityMgr.clsStringBuilder
  Dim sRevokeRoleList As New HrProSecurityMgr.clsStringBuilder
  Dim sSQLCommands As New HrProSecurityMgr.clsStringBuilder
...
'  Dim sUpdateDeny As String
  ...
  Dim cmdIsSysSecMgr As New ADODB.Command
  Dim pmADO As ADODB.Parameter
  Dim sSelectGrant As New HrProSecurityMgr.clsStringBuilder
  Dim sUpdateGrant As New HrProSecurityMgr.clsStringBuilder
  Dim sSQLCommands As New HrProSecurityMgr.clsStringBuilder
  Dim strColumnName As String
...
Private Function ApplyChanges_CreateViewValidationStoredProcedures() As Boolean
  ...
  Dim sSPCode As New HrProSecurityMgr.clsStringBuilder
  Dim sSQL As String
  Dim objGroup As SecurityGroup
  Dim objTable As SecurityTable
          ...
          If objTable.TableType = tabParent Then
            ...
            If fOK Then
              ...
              sSPCode.TheString = "/* ---------------------------------------------------------- */" & vbNewLine & _
                "/* HR Pro view validation stored procedure.                   */" & vbNewLine & _
...
Private Function ApplyChanges_DatabaseOwnership() As Boolean
  ...
  Dim sSQLCommand As New HrProSecurityMgr.clsStringBuilder
