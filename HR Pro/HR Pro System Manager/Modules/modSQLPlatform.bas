...
Public Function GenerateDropServerAssemblySP(ByRef bRunIt As Boolean) As Boolean
  ...
  sSQL = "/* ------------------------------------------------ */" & vbNewLine & _
    "/* HR Pro Drop Assembly stored procedure. */" & vbNewLine & _
    "/* Automatically generated by the System manager.   */" & vbNewLine & _
    "/* ------------------------------------------------ */" & vbNewLine & _
    "CREATE PROCEDURE spASRDropServerAssembly" & vbNewLine & _
    "AS" & vbNewLine & _
    "BEGIN" & vbNewLine
      
  sSQL = sSQL & _
      "  IF EXISTS (SELECT name FROM sys.assemblies WHERE name IN (N'HR Pro Server.Net'))" & vbNewLine & _
      "  BEGIN" & vbNewLine & _
      ...
      "      WHERE a.Name IN (N'HR Pro Server.Net')" & vbNewLine & _
      "    UNION" & vbNewLine & _
  ...
  If bRunIt Then
    gADOCon.Execute "EXEC spASRDropServerAssembly", , adExecuteNoRecords
  End If
