...
'Public Const gsEMAILTRIGGER = "dbo.sp_ASREmailTrigger_"
Public Const gsEMAILSEND = "dbo.spASRSysEmailSend_"

'Public Const gsREFRESHDATECOLUMNSJOBNAME = "job_ASRRefreshDateColumns_"
'Public Const gsEMAILPROCESSINGJOBNAME = "job_ASREmailProcessing_"
...
''#Login SPID to fix bug where connection does not clear on logoff
...
'
'Private miTriggerRecursionLevel As Integer      ' The trigger level on tables
'
'' Payroll Integration
'Private miAccordDefaultStatus As Integer
'Private mbAccordAllowDelete As Boolean
'Public Const gsACCORDTRANSFERTABLE = "HRProTable"
'
