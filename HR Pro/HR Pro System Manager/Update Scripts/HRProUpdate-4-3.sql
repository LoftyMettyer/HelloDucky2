...
PRINT 'Step - Populate code generation tables'
	...
	EXEC sp_executesql N'INSERT [dbo].[tbstat_componentcode] ([objectid], [code], [datatype], [name], [aftercode], [isoperator], [operatortype], [id], [rownumberrequired], [isuniquecode], [maketypesafe]) VALUES (N''a8974869-0964-40e9-bbbf-4ac6157bf07f'', N''[dbo].[udfsys_getuniquecode] ({0}, {1}, {2})'', 0, N''Unique Code'', NULL, 0, 0, 43, 1, 1, 1)';
