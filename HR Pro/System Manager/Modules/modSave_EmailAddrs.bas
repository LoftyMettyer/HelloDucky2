...
'  gADOCon.Execute strSQL, , adExecuteNoRecords
        ...
        If !Type <> 0 Then
          ...
          Case 2    'Calculated
            ...
            strSQL = strSQL & _
              ...
              "        SET @hResult = ltrim(rtrim(CONVERT(varchar(MAX), @EmailAddr)))" & vbNewLine & _
              "    END"
  ...
  strSQL = _
    ...
    "DECLARE @EmailAddr varchar(MAX)" & vbNewLine & vbNewLine & _
    strSQL & vbNewLine & _
...
Public Function CreateEmailSendStoredProcedure(strProcName As String, lngMethod As Long, strProfile As String, strServer As String, strAccount As String) As Boolean
  ...
  Case 1
    ...
    sSQL = sSQL & _
        "    IF rtrim(isnull(@Subject8000,'')) = '' SET @Subject8000 = char(9)" & vbCrLf & vbCrLf
