...
namespace Fusion.Test.SocialCare.Messages
{
    ...
    /// </summary>
    public class ServiceUserCareDeliveryAddressChangeRequestRequestXmlMetadataExtract : FusionXmlMetadataExtract<ServiceUserCareDeliveryAddressChangeRequest>
    {
        /// <summary>
        ...
        /// </returns>
        public override FusionXmlMetadata GetMetadataFromXml(ServiceUserCareDeliveryAddressChangeRequest message)
        {
            ...
            var rootNode = fusionDocument.Element(ns + "serviceUserCareDeliveryAddressChange");

            string entityRef = (string)rootNode.Attribute("serviceUserRef");
