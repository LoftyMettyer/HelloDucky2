...
namespace Fusion.Test.SocialCare.Messages
{
    ...
    /// </summary>
    public class StaffChangeRequestXmlMetadataExtract : FusionXmlMetadataExtract<StaffChangeRequest>
    {
        /// <summary>
        ...
        /// </returns>
        public override FusionXmlMetadata GetMetadataFromXml(StaffChangeRequest message)
        {
            ...
            var rootNode = fusionDocument.Element(ns + "staffChange");

            string entityRef = (string)rootNode.Attribute("staffRef");
