...
namespace Fusion.Test.SocialCare.Messages
{
    ...
    /// </summary>
    public class ServiceUserChangeRequestRequestXmlMetadataExtract : FusionXmlMetadataExtract<ServiceUserChangeRequest>
    {
        /// <summary>
        ...
        /// </returns>
        public override FusionXmlMetadata GetMetadataFromXml(ServiceUserChangeRequest message)
        {
            ...
            var rootNode = fusionDocument.Element(ns + "serviceUserChange");
