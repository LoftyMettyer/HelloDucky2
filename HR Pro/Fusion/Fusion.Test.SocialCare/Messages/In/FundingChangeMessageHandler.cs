...
namespace Fusion.Test.SocialCare.MessageHandlers
{
    ...
    /// </summary>
    public class FundingChangeMessageHandler : BaseWriteFileMessageHandler, IHandleMessages<FundingChangeMessage>
    {
        public void Handle(FundingChangeMessage message)
        {
