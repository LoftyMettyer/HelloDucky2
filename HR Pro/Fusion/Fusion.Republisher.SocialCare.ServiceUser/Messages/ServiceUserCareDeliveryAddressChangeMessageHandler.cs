...
namespace Fusion.Republisher.SocialCare
{
    ...
    public class ServiceUserCareDeliveryAddressChangeRequestMessageHandler : IHandleMessages<ServiceUserCareDeliveryAddressChangeRequest>
    {
        ...
        public void Handle(ServiceUserCareDeliveryAddressChangeRequest message)
        {
            Logger.Info(string.Format("Fusion Publisher received ServiceUserCareDeliveryAddressChangeRequest with Id {0}.", message.Id));
            ...
            // Blind republish
            Bus.Publish(new ServiceUserCareDeliveryAddressChangeMessage
            {
