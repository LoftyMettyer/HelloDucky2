...
namespace Fusion.Messages.SocialCare.Schemas
{
    ...
    partial class EntityBase<T> : IFusionXmlDto
    {
        ...
        private static System.Xml.Serialization.XmlSerializer Serializer
        {
            get
            {
                if ((serializer == null))
                {
                    serializer = new System.Xml.Serialization.XmlSerializer(typeof(T)); //, "http://advancedcomputersoftware.com/xml/fusion/socialCare");
                }
                return serializer;
            }
        }
