...
using Fusion.Messages.General;
    ...
    public interface IFusionLogService
    {
        ...
        void LogRefTranslationTransactional(string entityName, Guid busRef, string localId);
        ...
        void InfoMessageTransactional(Guid messageId, FusionLogLevel logLevel, Guid? entityRef, string messageName, string message);
        ...
        /// </summary>
        /// <param name="message"> The message. </param>
        void InfoMessageNonTransactional(Guid messageId, FusionLogLevel logLevel, Guid? entityRef, string messageName, string message);
