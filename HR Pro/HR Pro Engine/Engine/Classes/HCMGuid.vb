...
'  Public Shared Narrowing Operator CType(ByVal x As String) As Integer
'    Dim r As New Integer
'    r.Value(0) = x
'    Return r
'  End Operator

'  Public Shared Widening Operator CType(ByVal x As Integer) As String
'    Dim r As String
'    r = x(0).ToString
'    Return r
'  End Operator
...
'  <System.Diagnostics.DebuggerStepThrough()> _
'  Public Shared Operator =(ByVal x As Integer, ByVal y As Integer) As Boolean
'    Dim r As Boolean
'    r = (x(0) = y(0))
'    Return r
'  End Operator
...
'  Public Shared Operator &(ByVal Left As String, ByVal Right As Integer) As String
