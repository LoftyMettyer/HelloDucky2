          ...
          If objOrderItem.ColumnType = "O" Then
            Select Case objOrderItem.Ascending
              Case Enums.Order.Ascending
                aryOrderBy.Add(String.Format("[{0}].[{1}] {2}", objOrderItem.Column.Table.Name, objOrderItem.Column.Name, IIf(bReverseOrder, "DESC", "ASC")))
              Case Else
                aryOrderBy.Add(String.Format("[{0}].[{1}] {2}", objOrderItem.Column.Table.Name, objOrderItem.Column.Name, IIf(bReverseOrder, "ASC", "DESC")))
            End Select
