...
Public gbInScreenDesigner As Boolean

Private Function ShellEx( _
...
Public Function FormatAddress(ByVal pstrAddress As String) As String

  Dim strAddress As String

  strAddress = pstrAddress
  If Not InStr(1, pstrAddress, "http://") Then
    strAddress = "http://" & pstrAddress
  End If
