CREATE PROCEDURE [dbo].[spASRIntGetBlankIfZeroFindColumns] (
	@pfError 			bit 			OUTPUT, 
	@piTableID 			integer, 
	@piViewID 			integer, 
	@piOrderID 			integer, 
...
BEGIN
	...
	OPEN orderCursor;
	FETCH NEXT FROM orderCursor INTO @iColumnTableId, @sColumnName, @sColumnTableName, @sType, @bUseBlankIfZero;
