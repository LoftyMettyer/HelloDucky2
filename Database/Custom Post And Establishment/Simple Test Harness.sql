...
--INSERT Appointment_Absence_Entry (ID_3, start_date, start_session, end_date, end_session, Reason, absence_type) values (1000, getdate(), 'AM', getdate()+4, 'PM', 'malaria', 'Holiday')
